...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#09080c] text-[#e3e2e6] flex flex-col items-center justify-start sm:justify-center font-sans antialiased sm:py-6 sm:px-4">
      ...
      <div className="w-full sm:max-w-[430px] h-[100dvh] sm:h-[880px] sm:max-h-[92vh] bg-[#0f0e13] border-0 sm:border sm:border-[#49454f]/40 sm:rounded-[40px] shadow-2xl relative flex flex-col justify-start overflow-hidden sm:shadow-[0_0_50px_rgba(0,0,0,0.8)]">
