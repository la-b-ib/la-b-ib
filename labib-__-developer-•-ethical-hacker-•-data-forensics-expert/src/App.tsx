...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#09080c] text-[#e3e2e6] flex flex-col items-center justify-start sm:justify-center font-sans antialiased sm:py-6 sm:px-4">
      ...
      <div className="w-full sm:max-w-[430px] min-h-screen sm:min-h-[880px] sm:max-h-[92vh] bg-[#0f0e13] border-0 sm:border sm:border-[#49454f]/40 sm:rounded-[40px] shadow-2xl relative flex flex-col justify-start overflow-x-clip sm:overflow-x-hidden sm:overflow-y-auto sm:shadow-[0_0_50px_rgba(0,0,0,0.8)]">
        ...
        <header className="sticky top-0 sm:top-[29px] z-50 w-full bg-[#141218]/95 backdrop-blur-md border-b border-[#49454f]/20 shadow-none mt-0 shrink-0">
          <HudTopbar
            sfxActive={sfxActive}
