...
export const SKILLS_DATA: Skill[] = [
  ...
  // --- DEVELOPMENT TOOLS ---
  {
    ...
    tags: ['GPG Signing', 'Git Bisect', 'Hooks & CI', 'Submodules'],
  ...
  },
  {
    ...
    ecosystem: 'VS Code Insiders / Remote Containers',
  },
  {
    id: 'jetbrains',
...
export const MISSIONS_DATA: Mission[] = [
  ...
  {
    id: 'bts-blood-donor',
    title: 'Blood Donor & Community Volunteer',
