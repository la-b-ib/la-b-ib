  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto animate-fadeIn">
      <div className="bg-[#1a1b21] rounded-2xl border border-[#44474f] w-full max-w-3xl max-h-[calc(100dvh-60px)] overflow-y-auto p-6 space-y-6 shadow-2xl relative my-auto text-white font-mono text-xs">
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries(PRESET_VULNS).map(([key, val]) => (
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[#0f0e13] hover:bg-[#21232b] border border-[#44474f]/60 text-[#c4c6d0] hover:text-white transition-all cursor-pointer text-[11px] flex items-center space-x-1.5"
              >
        ...
        <div className="bg-[#0f0e13] p-5 rounded-2xl border border-[#44474f]/60 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-inner">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Attack Vector (AV) */}
          <div className="p-3.5 bg-[#0f0e13] rounded-xl border border-[#44474f]/40 space-y-2">
