...
export const DispatchesSection: React.FC = () => {
  ...
  return (
    <section id="blog" className="py-16 md:py-24 border-b border-white/10 bg-[#0f0e13] relative scroll-mt-28">
                        ...
                        {dispatch.codeSnippet && (
                          <div className="pt-1">
                            <button
                              ...
                              className="text-[11px] font-mono text-[#a8c7fa] hover:underline flex items-center space-x-1.5 cursor-pointer"
                            >
