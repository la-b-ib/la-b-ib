...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 border-b border-white/10 bg-[#0f0e13] relative scroll-mt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Section Header */}
        <div className="space-y-2 mb-10">
          <div className="text-xs font-mono text-[#a8c7fa] tracking-wider uppercase">Contact & Outreach</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-[#1a1b21] rounded-2xl border border-[#44474f]/40 p-6 space-y-5 shadow-md">
            ...
            <div className="space-y-3 font-mono text-xs">
              <a
                ...
                className="flex items-center space-x-3 p-3.5 rounded-xl bg-[#0f0e13]/80 hover:bg-[#0f0e13] text-[#c4c6d0] hover:text-white transition-all"
              >
              ...
              <div className="flex items-center space-x-3 p-3.5 rounded-xl bg-[#0f0e13]/80 text-[#c4c6d0]">
            ...
            <div className="bg-[#0f0e13]/80 p-4 rounded-xl space-y-2 text-xs font-sans">
          ...
          <div className="lg:col-span-7 bg-[#1a1b21] rounded-2xl border border-[#44474f]/40 p-6 shadow-md">
            <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0f0e13] border border-[#44474f]/50 rounded-xl p-3 text-white focus:outline-none focus:border-[#a8c7fa]"
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-[#0f0e13] border border-[#44474f]/50 rounded-xl p-3 text-white font-mono focus:outline-none focus:border-[#a8c7fa] resize-none"
                ></textarea>
              </div>
