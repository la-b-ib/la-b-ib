        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-6">
          <div className="space-y-1.5">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs leading-[12px] font-mono text-[#a8c7fa] tracking-widest uppercase font-semibold">
                SYS-ARCH & CORE
              </span>
            </div>
              ...
              {filteredSkills.map((skill) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-3.5 pt-2.5 flex items-center justify-between gap-2 border-t border-[#13141a] h-[32px]">
