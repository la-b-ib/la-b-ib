...
export const ArsenalSection: React.FC = () => {
  ...
  return (
    <section id="skills" className="pt-[15px] px-[15px] pb-[15px] border-b-0 bg-[#0f0e13] relative scroll-mt-28 font-sans">
          ...
          {CATEGORY_TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={`w-[35px] flex-1 h-[35px] flex items-center justify-center rounded-full transition-colors cursor-pointer text-center border-0 ${
                  isActive
                ...
                return (
                  ...
                  >
                    <div className="space-y-2.5">
                      ...
                      >
                        <div className="flex items-center space-x-2.5">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="text-[10px] font-mono text-[#8e9199] truncate">
                      ...
                      {skill.tags && skill.tags.length > 0 && (
                        <div className="flex flex-wrap gap-1 pt-0.5">
                          {skill.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-[10px] font-mono px-2 py-0.5 rounded-md bg-[#13141a] text-white"
                            >
                              #{tag}
                            </span>
                          ))}
                      ...
                      {isExpanded && (
                        <div className="mt-3 pt-3 border-t border-[#13141a] space-y-2.5 animate-fadeIn font-mono text-xs">
                    ...
                    <div className="mt-3.5 pt-2.5 flex items-center justify-between gap-2 border-t border-[#13141a]">
                      <div className="flex items-center space-x-1.5 overflow-hidden text-[11px] font-mono text-[#8e9199] bg-[#13141a] px-2.5 py-1.5 rounded-xl flex-1 min-w-0">
                        <span className="select-none font-bold shrink-0" style={{ color: accentColor }}>$</span>
                        <span className="truncate">{skill.command}</span>
                      </div>
                      <button
                        onClick={(e) => handleCopyCommand(e, skill)}
                        className={`w-[32px] h-[32px] rounded-xl flex items-center justify-center text-sm transition-all cursor-pointer shrink-0 border-0 shadow-sm ${
                          isCopied
