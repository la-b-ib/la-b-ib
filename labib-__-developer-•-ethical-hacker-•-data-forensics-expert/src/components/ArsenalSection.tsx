  ...
  return (
    <section id="skills" className="pt-[15px] px-[15px] pb-0 border-b-0 bg-[#0f0e13] relative scroll-mt-28 font-sans">
      <div className="max-w-7xl mx-auto px-0">
        ...
        <div className="flex items-center gap-1 bg-[#21232b] p-1 rounded-full border-0 h-[45px] mb-6 max-w-2xl w-full">
                  ...
                  >
                    ...
                    <div className="mt-3 pt-2.5 flex items-center justify-between gap-2 border-t border-[#21232b]">
                      ...
                      <button
                        ...
                        className={`w-[35px] h-[35px] rounded-full flex items-center justify-center text-sm transition-all cursor-pointer shrink-0 border-0 shadow-sm ${
                          isCopied
