...
export const CredentialsSection: React.FC = () => {
  ...
  return (
    <section id="certificates" className="py-16 md:py-24 border-b-0 bg-[#0f0e13] relative scroll-mt-28">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5 text-xs font-mono text-[#c4c6d0] pt-1">
                    ...
                    <p className="text-[#8e9199] flex items-center gap-1 text-[11px]">
                      <i className="ri-map-pin-2-line text-[#c23616]"></i> Location: {pub.location}
                    </p>
