          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 font-mono">
            ...
            <div className="h-[105px] bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between">
              ...
              <div className="h-[38px] bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
                <span className="text-xl sm:text-2xl font-bold text-[#a8c7fa] font-mono tracking-tight">{CERTIFICATIONS_DATA.length}</span>
            ...
            <div className="h-[105px] bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between">
              ...
              <div className="h-[38px] bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
                <span className="text-xl sm:text-2xl font-bold text-[#fdd663] font-mono tracking-tight">{BADGES_DATA.length}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4">
              {filteredCertifications.map((cert) => {
                ...
                return (
                  <div
                    key={cert.id}
                    className="h-auto bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col shadow-md"
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-2 shrink-0 min-h-[31.9965px]">
                        <div className="flex items-center gap-2.5 text-[11px] sm:text-xs font-bold text-[#a8c7fa] min-w-0 flex-1">
                          <div
                          ...
                          <div className="flex flex-col justify-center min-w-0 flex-1">
                            <span className="font-mono font-bold text-white text-[14px] sm:text-[15px] leading-tight break-words text-left line-clamp-2">
                              {cert.title}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2.5 shrink-0">
                          {cert.status && (
                            <span className="text-[10px] sm:text-[11px] text-[#a8c7fa] font-sans font-medium hidden sm:inline break-words">
                    ...
                    {isExpanded && (
                      <div className="mt-[15px] min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl p-3.5 sm:p-4 text-[12px] leading-[16.5px] text-[#a8aab3] font-sans space-y-2 animate-fadeIn">
                        ...
                        {cert.description && (
                          <div className="pt-2 text-[#a8aab3] text-justify text-[12px] leading-[16.5px] border-t border-[#44474f]/20">
                            {cert.description}
                          </div>
                        )}
                      </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-2 shrink-0 min-h-[31.9965px]">
                        <div className="flex items-center gap-2.5 text-[11px] sm:text-xs font-bold text-[#fdd663] min-w-0 flex-1">
                          <div
                        ...
                        <div className="flex items-center gap-2.5 shrink-0">
                          <span className="text-[10px] sm:text-[11px] text-[#a8c7fa] font-sans font-medium hidden sm:inline">CREDLY</span>
                    ...
                    {/* Inner Content Capsule Box (COLLAPSED BY DEFAULT, EXPANDED ON CLICK) */}
                    {isExpanded && (
                      <div className="mt-[15px] min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl p-3.5 sm:p-4 text-[12px] leading-[16.5px] text-[#a8aab3] font-sans space-y-2.5 animate-fadeIn">
                        {/* Interactive Learning Path Buttons in a Single Row */}
                        {badge.learningPath && badge.learningPath.length > 0 && (
                          <div
                            className="grid gap-1 sm:gap-1.5 w-full pb-1 border-b border-[#44474f]/25"
                            style={{
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-2 shrink-0 min-h-[31.9965px]">
                        <div className="flex items-center gap-2.5 text-[11px] sm:text-xs font-bold text-[#a8e6cf] min-w-0 flex-1">
                          <div
