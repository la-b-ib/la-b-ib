...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenTerminal, onNavigate }) => {
  ...
  return (
    <section id="hero" className="relative pt-6 pb-0 border-b-0 overflow-hidden scroll-mt-28 bg-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start pb-0 mb-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2 mb-[15px]">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="w-[72px] h-5 text-[9px] font-mono font-bold rounded bg-[#a8e6cf] text-[#00391c] inline-flex items-center justify-center shrink-0 uppercase">
                    CVE FEED
                  </span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="w-[72px] h-5 text-[9px] font-mono font-bold rounded bg-[#a8c7fa] text-[#042f5d] inline-flex items-center justify-center shrink-0 uppercase">
                    VOLATILITY
                  </span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="w-[72px] h-5 text-[9px] font-mono font-bold rounded bg-[#fdd663] text-[#3f2e00] inline-flex items-center justify-center shrink-0 uppercase">
                    SLA
                  </span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="w-[72px] h-5 text-[9px] font-mono font-bold rounded bg-[#d0bcff] text-[#381e72] inline-flex items-center justify-center shrink-0 uppercase">
                    VERIFIED
                  </span>
                </div>
                ...
                {activeMetricCard === 'UPTIME' && (
                  <div className="space-y-2 text-[11px]">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="bg-[#000000] p-2.5 rounded-xl border-0">
                        <span className="text-[#8e9199] block text-[10px]">ZT ENFORCEMENT</span>
                ...
                {activeMetricCard === 'CERTS' && (
                  <div className="space-y-2 text-[11px]">
                    <div className="flex flex-wrap gap-1.5 pt-1">
                      <span className="px-2 py-0.5 rounded-full bg-[#d0bcff] text-[#381e72] font-bold">EC-Council ISA</span>
                      <span className="px-2 py-0.5 rounded-full bg-[#fdd663] text-[#3f2e00] font-bold">CompTIA Sec+</span>
                      <span className="px-2 py-0.5 rounded-full bg-[#a8e6cf] text-[#00391c] font-bold">FCA</span>
                    </div>
                    <p className="text-[#c4c6d0] text-[11px] leading-relaxed">
          ...
          <div className="lg:col-span-5 space-y-3 pb-0 mb-0">
            ...
            <div className="space-y-3 font-mono text-xs pb-0 mb-0">
              {/* Node Status Info */}
              <div className="grid grid-cols-2 gap-2 text-[11px] bg-transparent border-b border-[#44474f]/30 pb-3 mb-[15px]">
                <div>
              ...
              <div className="space-y-2 border-b border-[#44474f]/30 pb-3 mb-[15px]">
                <div className="text-[#e3e2e6] font-semibold flex items-center justify-between text-[11px] mb-[5px]">
              ...
              <div className="space-y-2.5 pt-2 pb-0 mb-0">
                <div className="text-[#8e9199] font-semibold text-[11px] flex items-center justify-between mb-[5px]">
                  ...
                  <span className="text-[10px] font-mono font-bold text-[#003822] bg-[#a8e6cf] px-2 py-0.5 rounded-full flex items-center gap-1">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 pt-0.5">
                          ...
                          <span
                            className={`w-12 h-4 text-[9px] font-bold tracking-wider rounded inline-flex items-center justify-center shrink-0 uppercase ${badgeStyle}`}
                          >
                            {log.tag}
                          </span>
                        </div>
