...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenTerminal, onNavigate }) => {
  ...
  return (
    <section id="hero" className="relative pt-0 pb-0 border-b-0 overflow-hidden scroll-mt-28 bg-black">
      ...
      <div className="w-full pt-0 px-0 mb-6 overflow-hidden">
        <img
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start pb-0 mb-0">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="font-jetbrains text-xs sm:text-sm md:text-base text-teal-300/90 flex items-center space-x-2 bg-[#21232b] px-3 rounded-lg border-0 h-[45px] max-w-[346px] w-full min-h-0 shadow-none">
              ...
              <span className="leading-snug truncate">{phrases[phraseIdx].substring(0, charIdx)}</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2 mb-[15px]">
              ...
              >
                <div className="flex items-center justify-between">
                  <i className="ri-bug-2-line text-lg text-[#a8e6cf]"></i>
                  <span className="px-2 h-5 text-xs font-mono font-bold rounded bg-[#a8e6cf] text-[#00391c] inline-flex items-center justify-center shrink-0 uppercase">
                    CVE FEED
                  </span>
                </div>
                ...
                <div className="text-xs font-medium text-[#c4c6d0] mt-1 leading-tight">
                  Disclosed Vulns
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <i className="ri-ram-line text-lg text-[#a8c7fa]"></i>
                  <span className="px-2 h-5 text-xs font-mono font-bold rounded bg-[#a8c7fa] text-[#042f5d] inline-flex items-center justify-center shrink-0 uppercase">
                    VOLATILITY
                  </span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <i className="ri-swap-3-line text-lg text-[#fdd663]"></i>
                  <span className="px-2 h-5 text-xs font-mono font-bold rounded bg-[#fdd663] text-[#3f2e00] inline-flex items-center justify-center shrink-0 uppercase">
                    SLA
                  </span>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <i className="ri-certificate-line text-lg text-[#d0bcff]"></i>
                  <span className="px-2 h-5 text-xs font-mono font-bold rounded bg-[#d0bcff] text-[#381e72] inline-flex items-center justify-center shrink-0 uppercase">
                    VERIFIED
                  </span>
                </div>
            ...
            {activeMetricCard && (
              <div className="bg-[#21232b] border-0 rounded-2xl p-4 shadow-xl animate-fadeIn font-mono text-xs space-y-3">
                <div className="flex items-center justify-between border-b border-[#49454f]/30 pb-2">
                  ...
                  <button
                    ...
                    className="text-[#690005] hover:opacity-90 p-1 rounded-[15px] bg-[#ffb4ab] transition-colors flex items-center justify-center cursor-pointer"
                    title="Close details"
                  >
            ...
            <div className="grid grid-cols-3 gap-2 pt-0 w-full">
              <button
                onClick={() => {
                  onOpenTerminal();
                  soundEngine.play('click');
                }}
                className="m3-btn-primary cursor-pointer justify-center !px-2 sm:!px-4 !py-2 !text-xs sm:!text-sm flex items-center space-x-1 h-[45px]"
              >
          ...
          <div className="lg:col-span-5 space-y-3 pb-0 mb-0">
            ...
            <div className="flex items-center pb-1 mb-[5px]">
            ...
            <div className="space-y-3 font-mono text-xs pb-0 mb-0">
              {/* Node Status Info */}
              <div className="grid grid-cols-2 gap-2 text-xs leading-[12.6667px] bg-transparent border-b border-[#44474f]/30 pb-3 mb-[15px]">
                <div>
                  <span className="text-[#8e9199] text-xs">HOST_NODE:</span>{' '}
                  <span className="text-[#a8e6cf] font-bold text-xs">SEC-NODE-01</span>
                </div>
                <div>
                  <span className="text-[#8e9199] text-xs">KERNEL:</span>{' '}
                  <span className="text-[#e3e2e6] text-xs">Linux 6.8 (eBPF)</span>
                </div>
                <div>
                  <span className="text-[#8e9199] text-xs">ENCRYPTION:</span>{' '}
              ...
              <div className="space-y-2 border-b border-[#44474f]/30 pb-3 mb-[15px]">
                <div className="text-[#e3e2e6] font-semibold flex items-center justify-between text-xs mb-[5px]">
                  <span className="flex items-center gap-1.5 text-[#a8e6cf] text-xs">
                    <i className="ri-key-2-line text-sm"></i> Hash Generator
                  </span>
                  <span className="text-xs text-[#8e9199]">WebCrypto API</span>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-full bg-[#21232b] border-0 rounded-lg px-3 h-[45px] text-white font-mono text-xs focus:outline-none focus:ring-1 focus:ring-[#a8c7fa]"
                  />
                </div>
              ...
              <div className="space-y-2.5 pt-2 pb-0 mb-0">
                <div className="text-[#8e9199] font-semibold text-xs flex items-center justify-between mb-[5px]">
                  <span className="flex items-center gap-1.5 text-[#a8c7fa] font-mono text-xs">
                    <i className="ri-radar-line text-sm text-[#a8c7fa] animate-pulse"></i> REAL-TIME TELEMETRY LOGS
                  </span>
                  <span className="text-xs font-mono font-bold text-[#003822] bg-[#a8e6cf] px-2 py-0.5 rounded-full flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#003822] animate-ping"></span>
                    LIVE STREAM
                  </span>
                </div>

                <div className="space-y-1.5 max-h-64 sm:max-h-72 overflow-y-auto font-mono text-xs pr-1 custom-scrollbar pb-0 mb-0">
                  {streamLogs.map((log, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className="py-1.5 border-b border-[#49454f]/20 last:border-b-0 last:pb-0 flex items-start gap-2 leading-relaxed text-xs"
                      >
                        {/* Timestamp & Badge Column */}
                        <div className="flex items-center gap-1.5 shrink-0 pt-0.5">
                          <span className="text-[#8e9199] text-xs font-mono shrink-0">
                            [{log.time}]
                          </span>
                          <span
                            className={`px-1.5 h-4 text-xs font-bold tracking-wider rounded inline-flex items-center justify-center shrink-0 uppercase ${badgeStyle}`}
                          >
                            {log.tag}
                          </span>
                        </div>
                        ...
                        <div className="flex-1 min-w-0 text-[#e3e2e6] font-mono break-words leading-snug text-xs">
                          {log.msg}
                        </div>
                      </div>
                    );
