      ...
      <div className="max-w-7xl mx-auto px-[15px] relative z-10 pb-0 mb-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start pb-0 mb-0">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="font-jetbrains text-xs sm:text-sm md:text-base text-teal-300/90 flex items-center space-x-2 bg-[#21232b] px-3 rounded-lg border-0 h-[31.5px] max-w-[346px] w-full min-h-0 shadow-none">
              ...
              <div className="space-y-2 border-b border-[#44474f]/30 pb-3">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-full bg-[#21232b] border-0 rounded-lg px-3 h-[31.5px] text-white font-mono text-xs focus:outline-none focus:ring-1 focus:ring-[#a8c7fa]"
                  />
                </div>
