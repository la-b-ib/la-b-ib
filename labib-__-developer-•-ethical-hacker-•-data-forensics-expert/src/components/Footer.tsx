...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className={`w-full bg-[#0a0a0e] border-0 border-t-0 shadow-none ${activeSection === 'hero' ? 'pt-[15px]' : 'pt-6 sm:pt-8'} pb-[90px] lg:pb-8 text-xs font-mono text-[#8e9199] relative z-20`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <div className="bg-[#21232b] p-4 sm:p-6 rounded-2xl border-0 shadow-none space-y-6 text-[11px] font-mono">
          ...
          {/* Row 2: Latency & PGP */}
          <div className="grid grid-cols-2 max-w-sm gap-x-6 gap-y-2 text-xs text-[#8e9199] pb-4 border-0">
