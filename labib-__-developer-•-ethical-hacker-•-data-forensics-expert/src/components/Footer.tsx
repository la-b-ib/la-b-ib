...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className={`w-full bg-[#0a0a0e] border-0 border-t-0 shadow-none ${activeSection === 'skills' ? 'pt-0' : activeSection === 'hero' || activeSection === 'experience' || activeSection === 'about' || activeSection === 'threat-map' || activeSection === 'dispatch' || activeSection === 'certificates' ? 'pt-[15px]' : 'pt-6 sm:pt-8'} pb-0 text-xs font-mono text-[#8e9199] relative z-20`}>
