...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className={`w-full bg-[#0a0a0e] border-0 border-t-0 shadow-none ${activeSection === 'skills' ? 'pt-0' : activeSection === 'hero' || activeSection === 'experience' || activeSection === 'about' || activeSection === 'threat-map' ? 'pt-[15px]' : 'pt-6 sm:pt-8'} pb-[90px] lg:pb-8 text-xs font-mono text-[#8e9199] relative z-20`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-10">
        
        {/* M3 Expressive Container for Operations & Telemetry */}
        <div className="bg-[#21232b] p-4 sm:p-6 rounded-2xl border-0 shadow-none space-y-6 text-[11px] font-mono">
          
          {/* Row 1: SOC NODE : ONLINE & BUILD */}
          <div className="flex items-center justify-between gap-3 text-[#c4c6d0] mb-[5px]">
            <span className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-[#a8c7fa] text-[#003258] font-bold text-[10px]">
          ...
          {/* Copyright Line */}
          <div>
            <span className="text-white font-bold tracking-tight flex items-center gap-1 mb-[-15px]">
