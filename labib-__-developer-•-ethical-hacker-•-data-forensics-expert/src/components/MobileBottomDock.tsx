...
export const MobileBottomDock: React.FC<MobileBottomDockProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-black h-[94px] pt-[15px] pb-[calc(15px+env(safe-area-inset-bottom,0px))] px-[15px] flex items-center justify-center">
