...
export const MobileBottomDock: React.FC<MobileBottomDockProps> = ({
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#090b10] border-0 pt-2.5 pb-2.5 px-[15px]">
      <div className="bg-[#21232b] backdrop-blur-xl border-0 rounded-2xl p-1.5 px-[15px] shadow-2xl flex items-center justify-around max-w-md mx-auto">
