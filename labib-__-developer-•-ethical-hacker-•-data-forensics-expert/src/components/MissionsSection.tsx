          ...
          {MISSIONS_DATA.map((mission) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <div className="flex items-center justify-between gap-2.5">
                    <div className="flex items-start gap-2.5 min-w-0 flex-1">
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center text-base font-bold bg-[#a8c7fa] text-[#00325b] shrink-0 mt-0.5">
                ...
                <p className="text-xs sm:text-sm text-[#c4c6d0] leading-relaxed font-sans mt-[15px] text-justify">
                  {mission.summary}
                </p>
                  ...
                  <div className="flex items-center justify-between border-b border-[#44474f]/30 pb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-base font-bold text-white flex items-center gap-1.5">
                          {rec.linkedIn && (
                            <a
                              ...
                              className="text-[#a8c7fa] hover:text-white transition-colors shrink-0 inline-flex items-center"
                        ...
                        <p className="text-xs text-[#a8c7fa] font-medium mt-0.5">
                          {rec.role}
                        </p>
                      </div>
                    </div>
