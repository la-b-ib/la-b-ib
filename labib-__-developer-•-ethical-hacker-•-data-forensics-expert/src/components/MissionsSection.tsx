        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {MISSIONS_DATA.map((mission) => {
            ...
            return (
              <div
                key={mission.id}
                className="bg-[#21232b] border-0 p-4 sm:p-5 rounded-2xl transition-all relative overflow-hidden group"
              >
                {/* Header Row */}
                <div>
                ...
                <p className="text-xs sm:text-sm text-[#c4c6d0] leading-relaxed font-sans mt-3 text-justify">
                  {mission.summary}
                </p>

                {/* Collapsible Content: Bullets List (Justified) */}
                {isExpanded && (
                  <div className="space-y-3 pt-3 mt-3 border-t border-[#44474f]/30">
        ...
        <div className="space-y-3.5 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            {RECOMMENDATIONS_DATA.map((rec) => (
              <div
                key={rec.id}
                className="bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between group relative shadow-md gap-2.5"
              >
                {/* Header Row */}
                ...
                {/* Content Capsule Box */}
                <div className="min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl p-3.5 sm:p-4 text-[12px] leading-[19px] text-[#c4c6d0] font-sans flex-1">
