...
export const SearchSection: React.FC<SearchSectionProps> = ({
  ...
  return (
    <section className="w-full flex-1 flex flex-col bg-[#0f0e13] min-h-full border-t border-white/10 text-white font-mono animate-fadeIn pb-[calc(94px+env(safe-area-inset-bottom,0px))] sm:pb-0">
