...
===================================================================`,
  ...
  return (
    <section className="w-full flex-1 flex flex-col min-h-0 bg-[#0f0e13] text-white font-mono animate-fadeIn transition-all pb-[calc(94px+env(safe-area-inset-bottom,0px))] sm:pb-0">
