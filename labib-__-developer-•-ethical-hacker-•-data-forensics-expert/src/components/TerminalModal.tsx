  ...
  return (
    <section className="w-full flex-1 flex flex-col min-h-0 bg-[#0f0e13] text-white font-mono animate-fadeIn transition-all">
      <div className="w-full flex-1 flex flex-col min-h-0 bg-[#0f0e13]">
        ...
        {/* Command Input Container with solid black background from top 15px to screen bottom, left to right */}
        <div className="sticky bottom-[94px] w-full z-45 bg-black pt-[15px] pb-0 px-[15px] flex justify-center items-center">
          <form
