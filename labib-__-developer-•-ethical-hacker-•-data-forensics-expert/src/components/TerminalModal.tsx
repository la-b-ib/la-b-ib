  ...
  return (
    <section className="w-full flex-1 flex flex-col min-h-0 bg-[#0f0e13] text-white font-mono animate-fadeIn transition-all">
      <div className="w-full flex-1 flex flex-col min-h-0 bg-[#0f0e13]">
        ...
        <div className="fixed bottom-[94px] left-0 right-0 z-30 px-[15px] pointer-events-none flex justify-center">
          <form
            onSubmit={handleSubmit}
            className="pointer-events-auto w-full max-w-md sm:max-w-[430px] bg-[#21232b] px-[10px] h-[45px] rounded-xl border-0 flex items-center gap-2 sm:gap-3 transition-colors shadow-2xl"
          >
