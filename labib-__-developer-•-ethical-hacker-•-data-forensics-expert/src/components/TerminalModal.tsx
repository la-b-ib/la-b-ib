...
===================================================================`,
  ...
  return (
    <section className="w-full h-full flex flex-col min-h-0 bg-[#0f0e13] text-white font-mono animate-fadeIn transition-all pb-[calc(94px+env(safe-area-inset-bottom,0px))] sm:pb-0">
      <div className="w-full h-full flex flex-col min-h-0 bg-[#0f0e13]">
        ...
        <div className="w-full z-45 bg-black pt-[15px] pb-0 px-[15px] h-[60px] flex justify-center items-center shrink-0">
          <form
            ...
            className="w-full max-w-md sm:max-w-[430px] bg-[#21232b] px-[10px] h-[45px] rounded-xl border border-[#44474f]/40 flex items-center gap-2 sm:gap-3 transition-colors shadow-[0_8px_30px_rgba(0,0,0,0.7)]"
          >
            <span className="text-[#a8c7fa] font-mono font-semibold text-[16px] sm:text-[12px] leading-[16px] sm:leading-[12px] flex items-center shrink-0 gap-1.5">
              <span className="text-[#8e9199] hidden sm:inline">node-{String(cmdHistory.length).padStart(2, '0')}:</span>
              <i className="ri-money-dollar-circle-line text-[20px] sm:text-[16px] text-[#a8c7fa]"></i>
            </span>
            <div className="relative flex-1 flex items-center h-full">
              <input
                ...
                className="w-full bg-transparent border-none text-white font-mono text-[16px] sm:text-[12px] leading-[16px] sm:leading-[12px] focus:outline-none placeholder:text-[#8e9199] placeholder:text-[16px] sm:placeholder:text-[12px] placeholder:leading-[16px] sm:placeholder:leading-[12px] h-[45px] z-10"
              />
              {ghostText && inputVal.trim() && (
                <span className="absolute left-0 pointer-events-none font-mono text-[16px] sm:text-[12px] leading-[16px] sm:leading-[12px] text-[#44474f] whitespace-pre min-h-[36px] flex items-center">
