...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <div ref={navRef} className="w-full py-2.5 sm:py-3 relative">
      <div className="max-w-7xl mx-auto px-[15px] sm:px-6 lg:px-8 flex items-center justify-between gap-4">
        ...
        >
          ...
          <div className="relative flex items-center justify-center w-[32px] h-[32px] rounded-none sm:rounded-lg bg-[#21232b] transition-all overflow-hidden shrink-0">
            <img
