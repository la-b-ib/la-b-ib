...
- Status        : MATCH (Constant-Time String Compare: 0 ns delta)`;
  ...
  return (
    <div className="space-y-6 font-sans text-white">
      ...
      {/* Header */}
      <div className="border-b border-[#44474f]/30 pb-4">
      ...
      {/* PGP KEY CARD - Directly in bg, copy button inside container */}
      <div className="space-y-2 font-mono text-xs">
        ...
        <div className="bg-[#21232b] p-3 rounded-lg border-0 flex items-center justify-between gap-3">
          <div className="text-[#fdd663] font-mono tracking-tight break-all select-all flex-1 min-w-0">
            {pgpFingerprint}
          </div>
          <button
            type="button"
      ...
      {/* INTERACTIVE SIGNATURE GENERATOR - Directly in bg, no container border */}
      <div className="space-y-4 font-mono text-xs pt-1">
        <div className="text-xs font-bold text-[#a8c7fa] flex items-center gap-1.5 border-b border-[#44474f]/30 pb-2">
          <i className="ri-archive-stack-line"></i> SIG-DISPATCH
        </div>
        ...
        <div className="space-y-1">
          ...
          <textarea
            ...
            className="w-full bg-[#21232b] border-0 rounded-xl p-3 text-white text-xs focus:outline-none"
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full bg-[#21232b] border-0 rounded-xl px-3 py-2 text-white text-xs focus:outline-none"
          />
        </div>
        ...
        {signatureOutput && (
          <div className="p-3 bg-[#21232b] rounded-xl border-0 space-y-2 animate-fadeIn">
            ...
            <pre className="text-[10px] sm:text-[11px] text-[#c4c6d0] bg-[#0f0e13] p-[10px] rounded-lg border-0 whitespace-pre-wrap break-words break-all font-mono leading-[11px] overflow-x-hidden">
              {signatureOutput}
            </pre>
          </div>
        )}
