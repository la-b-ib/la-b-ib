...
- Status        : MATCH (Constant-Time String Compare: 0 ns delta)`;
  ...
  return (
    <div className="font-sans text-white">
      ...
      <div className="h-[120px] bg-[#21232b] p-3.5 sm:p-4 rounded-2xl border-0 flex flex-col justify-between font-mono text-xs">
        ...
        <div className="h-[45px] bg-[#13141a] px-3 sm:px-4 py-1.5 rounded-xl border-0 flex items-center">
      ...
      <div className="font-mono text-xs mt-[15px] space-y-[15px]">
        ...
        <div className="bg-[#21232b] p-3.5 sm:p-4 rounded-2xl border-0 space-y-3">
          <div className="text-xs font-bold text-[#a8c7fa] flex items-center gap-2 border-b border-[#44474f]/30 pb-2">
          ...
          <div>
            <textarea
              ...
              className="w-full h-[45px] leading-[12px] bg-[#13141a] border-0 rounded-xl p-3 text-white text-xs focus:outline-none placeholder:text-[#8e9199] resize-none"
            />
          </div>
          ...
          <div>
            <input
              ...
              className="w-full h-[46px] bg-[#13141a] border-0 rounded-xl px-3 py-2.5 text-white text-xs focus:outline-none placeholder:text-[#8e9199]"
            />
          </div>
        </div>
