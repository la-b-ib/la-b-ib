...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-16 md:py-24 border-b border-white/10 bg-[#0f0e13] relative scroll-mt-28 font-sans">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-[#8e9199] flex items-center gap-1 mt-1">
                    <i className="ri-map-pin-2-line text-[#a8c7fa]"></i> Dhaka, Bangladesh / Global Ops
                  </div>
                </div>
              </div>
            </div>
