          ...
          <div className="w-full">
            ...
            {activeTab === 'academic' && (
              <div className="space-y-10 animate-fadeIn font-mono">
                ...
                <div>
                  <div className="bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-center gap-0.5">
                      ...
                      <div className="flex items-center justify-between gap-2 text-[12px] leading-[15px] flex-wrap sm:flex-nowrap">
                        <span className="font-semibold text-[#a8c7fa] break-words">
                        ...
                        <div className="flex items-center text-[#9CA3AF] font-mono font-medium tracking-wide shrink-0">
                          ...
                          <span className="mx-0.5 sm:mx-1 opacity-70">:</span>
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-[15px]">
                  ...
                  <div className="col-span-2 min-h-[105px] h-auto bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between gap-2.5">
                    <div className="h-[30px] flex items-center justify-between border-b border-[#44474f]/30 pb-1.5 shrink-0">
                      <div className="flex items-center gap-2 text-[11px] sm:text-xs font-bold text-[#a8e6cf]">
                        <div
                          className="w-[28px] h-[28px] shrink-0 rounded-lg bg-[#a8e6cf] text-[#003923] flex items-center justify-center text-base font-bold shadow-sm"
                          title="Organizations, Societies & Clubs"
                        >
                          <i className="ri-team-line"></i>
                        </div>
                        <span className="truncate">ORGS & CLUBS</span>
                      </div>
                      <span className="text-[10px] sm:text-[11px] text-[#8e9199] font-sans font-medium">AFFIL</span>
                    </div>
                    <div 
                      className="min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-2 text-[11px] sm:text-xs text-[#c4c6d0] font-mono leading-relaxed whitespace-normal break-words flex items-center"
                  ...
                  <div className="col-span-2 min-h-[105px] h-auto bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between gap-2.5">
                    <div className="h-[30px] flex items-center justify-between border-b border-[#44474f]/30 pb-1.5 shrink-0">
                      <div className="flex items-center gap-2 text-[11px] sm:text-xs font-bold text-[#c2e7ff]">
                        <div
                          className="w-[28px] h-[28px] shrink-0 rounded-lg bg-[#c2e7ff] text-[#00325b] flex items-center justify-center text-base font-bold shadow-sm"
                      ...
                      <span className="text-[10px] sm:text-[11px] text-[#8e9199] font-sans font-medium">PUBS</span>
                    </div>
                    <div className="min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-2 text-[11px] sm:text-xs text-[#c4c6d0] font-mono leading-relaxed space-y-1">
          ...
          {activeTab === 'dossier' && (
            <div className="space-y-4 animate-fadeIn font-mono">
              ...
              <div className="space-y-3.5">
                ...
                <div className="grid grid-cols-1 gap-3.5">
                  {PUBLICATIONS_DATA.map((pub) => (
                    <div
                      key={pub.id}
                      className="min-h-[105px] h-auto bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between gap-2.5"
                    >
                      {/* Card Header */}
                      <div className="h-auto min-h-[30px] flex items-center justify-between gap-2 shrink-0">
                        <div className="flex items-center gap-2.5 text-[11px] sm:text-xs font-bold text-[#c2e7ff] min-w-0 flex-1">
                          <div
                      ...
                      {/* Card Content Capsule Box */}
                      <div className="min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl p-3.5 sm:p-4 text-[12px] leading-[19px] text-[#c4c6d0] font-mono space-y-2.5">
                        <div className="space-y-1.5 text-justify">
                          <div className="flex flex-row items-start gap-2">
                            <span className="text-[#8e9199] font-bold shrink-0 w-16 sm:w-20">TITLE</span>
                          ...
                          <div className="flex flex-row items-start gap-2">
                            <span className="text-[#8e9199] font-bold shrink-0 w-16 sm:w-20">CONF</span>
                            <span className="text-[#8e9199] shrink-0">:</span>
                            <span className="text-[#c2e7ff] break-words flex-1 text-justify">{pub.venueFull || pub.conference}</span>
                          </div>

                          <div className="flex flex-row items-start gap-2">
                            <span className="text-[#8e9199] font-bold shrink-0 w-16 sm:w-20">LOC</span>
                            <span className="text-[#8e9199] shrink-0">:</span>
                            <span className="text-white break-words flex-1 text-justify">{pub.location}</span>
                          </div>

                          <div className="flex flex-row items-start gap-2">
                            <span className="text-[#8e9199] font-bold shrink-0 w-16 sm:w-20">DATE</span>
                            <span className="text-[#8e9199] shrink-0">:</span>
                            <span className="text-white break-words flex-1 text-justify">{pub.date}</span>
                          </div>

                          <div className="flex flex-row items-start gap-2">
                            <span className="text-[#8e9199] font-bold shrink-0 w-16 sm:w-20">DOI</span>
                            <span className="text-[#8e9199] shrink-0">:</span>
                            <a
                              href={pub.doi}
                              target="_blank"
                          ...
                          <div className="flex flex-row items-start gap-2">
                            <span className="text-[#8e9199] font-bold shrink-0 w-16 sm:w-20">E-ISBN</span>
                            <span className="text-[#8e9199] shrink-0">:</span>
              ...
              <div className="space-y-3.5 pt-2">
                ...
                {/* 4 Research Portals Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                  {PROFILES_DATA.filter((p) =>
                    ['IEEE Xplore', 'Google Scholar', 'ORCID iD', 'ResearchGate'].includes(p.name)
                  ).map((portal) => (
                    <div
                      key={portal.name}
                      className="min-h-[105px] h-auto bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between gap-2.5"
                    >
                      ...
                      <div className="h-auto min-h-[30px] flex items-center justify-between gap-2 shrink-0">
                        <div className="flex items-center gap-2.5 text-[11px] sm:text-xs font-bold text-[#c2e7ff] min-w-0 flex-1">
                          <div
                            className="w-[32px] h-[32px] shrink-0 rounded-[8px] bg-[#a8e6cf] text-[#003923] flex items-center justify-center text-base font-bold shadow-sm"
                            title={portal.name}
                          >
                          ...
                          <div className="flex flex-col justify-center min-w-0">
                            ...
                            <span className="text-[11px] text-[#a8e6cf] font-mono font-medium tracking-wider leading-tight mt-0.5">
                              {portal.status}
                            </span>
                          </div>
                        </div>
                        ...
                        <a
                          ...
                          className="w-[32px] h-[32px] rounded-[8px] bg-[#a8e6cf] hover:bg-[#c6f6d5] text-[#003923] flex items-center justify-center text-base font-bold shadow-sm transition-all shrink-0 cursor-pointer"
                        >
                          <i className="ri-link-unlink-m"></i>
                        </a>
                      </div>
                      ...
                      {/* Content Capsule Box */}
                      <div className="min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl p-3.5 sm:p-4 text-[12px] leading-[19px] text-[#c4c6d0] font-mono space-y-2">
                        <div className="flex flex-row items-start gap-2">
                          <span className="text-[#8e9199] font-bold shrink-0 w-14">PROFILE</span>
                          <span className="text-[#8e9199] shrink-0">:</span>
                          <span className="font-bold text-white leading-snug break-words flex-1">{portal.platform}</span>
                        </div>

                        <div className="flex flex-row items-start gap-2">
                          <span className="text-[#8e9199] font-bold shrink-0 w-14">SCOPE</span>
                          <span className="text-[#8e9199] shrink-0">:</span>
                          <span className="text-[#c4c6d0] leading-relaxed break-words flex-1 font-sans text-xs">{portal.description}</span>
                        </div>
                      </div>
                    </div>
                  ))}
