...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-12 md:py-20 border-b-0 bg-[#0f0e13] relative scroll-mt-28 font-mono text-white">
      <div className="max-w-7xl mx-auto px-[15px] space-y-8">
        ...
        <div className="w-full">
          ...
          {activeTab === 'dossier' && (
            <div className="space-y-8 animate-fadeIn font-mono pt-2">
              ...
              <div className="bg-[#1a1b21]/60 p-6 rounded-2xl border border-[#44474f]/40 space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-xs text-[#fbbc05] font-bold">
                    <i className="ri-key-2-line text-base"></i>
                    <span>PUBLIC PGP KEY FINGERPRINT (RSA 4096-BIT)</span>
                  </div>
                  <button
                    onClick={copyPgp}
                    className="px-3 py-1 rounded-xl bg-[#21232b] hover:bg-[#2b2d36] text-[#c2e7ff] text-xs font-mono font-semibold transition-all cursor-pointer border border-[#44474f]/40"
                  >
                    {copiedPgp ? 'FINGERPRINT COPIED' : 'COPY FINGERPRINT'}
                  </button>
                </div>
                <div className="text-xs text-[#a8e6cf] font-mono tracking-wider break-all select-all bg-[#0f0e13] p-4 rounded-xl border border-[#44474f]/30">
                  {pgpFingerprint}
                </div>
              </div>
