                ...
                <div className="grid grid-cols-1 gap-3.5">
                  {PUBLICATIONS_DATA.map((pub) => {
                    ...
                    return (
                      <div
                        key={pub.id}
                        className="h-auto bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between gap-2.5"
                      >
                        {/* Card Header */}
                        ...
                        {isExpanded && (
                          <div className="h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl p-3.5 sm:p-4 text-[12px] leading-[19px] text-[#c4c6d0] font-mono space-y-2.5 animate-fadeIn">
              ...
              <div className="space-y-3.5 pt-2">
                ...
                <div className="grid grid-cols-2 gap-2.5 sm:gap-3.5">
                  {ACADEMIC_PORTALS_DATA.map((portal) => (
                    <div
                      key={portal.name}
                      className="h-[56.9792px] bg-[#21232b] border-0 px-2.5 sm:px-3.5 rounded-2xl transition-all flex items-center justify-between gap-2"
                    >
                      {/* Portal Header */}
