        ...
        <div className="font-mono pt-2">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-end space-x-1 h-6 pt-1">
                    {sparkline.map((val, idx) => (
                      <div
                        key={idx}
                        className="flex-1 bg-[#21232b] group-hover:bg-[#fdd663]/20 rounded-t transition-all duration-300 relative"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start pt-4">
              ...
              <div className="lg:col-span-7 space-y-4 relative flex flex-col justify-start">
                ...
                {/* ATTACK FLOW (ORIGIN -> TARGET) DIRECTLY ON BG */}
                <div className="flex flex-col justify-between space-y-3 relative font-mono pt-1">
                    ...
                    <div className="space-y-1.5 min-w-0">
                      <div className="flex items-center justify-between gap-1.5 min-w-0 w-full">
                        <div className="flex items-center space-x-2 min-w-0 flex-1 overflow-hidden">
                          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#21232b] flex items-center justify-center shrink-0 border border-[#44474f]/30">
