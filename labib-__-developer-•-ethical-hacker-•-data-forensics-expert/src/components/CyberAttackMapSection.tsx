      ...
      <div className="max-w-7xl mx-auto px-0 space-y-6">
        ...
        <div className="border-b border-[#44474f]/30 pb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="w-full md:w-auto flex items-center">
            ...
            <div className="w-full md:w-auto h-[45px] flex items-center justify-between space-x-1.5 bg-[#21232b] px-2 rounded-full border-0 shadow-md">
              <button
                onClick={() => {
                  setActiveRadarTab('radar');
                  soundEngine.play('click');
                }}
                className={`flex-1 md:flex-initial md:w-[35px] h-[35px] px-2 md:px-0 rounded-full text-xs font-mono font-bold transition-all cursor-pointer flex items-center justify-center ${
              ...
              <button
                onClick={clearLogs}
                className={`flex-1 md:flex-initial md:w-[35px] h-[35px] px-2 md:px-0 rounded-full text-xs font-mono font-bold transition-all cursor-pointer flex items-center justify-center border-0 active:scale-95 ${
                  isDeleting
        ...
        {activeRadarTab === 'auditor' ? (
          ...
          <div className="flex flex-col justify-between space-y-3 relative group transition-all">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="px-2 h-[25px] flex items-center justify-center rounded-full text-[8px] font-bold bg-[#ffb4ab] text-[#690005] border-0">
                  +{lastDelta}
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between space-y-3 relative group transition-all">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[9px] font-bold px-2 h-[25px] flex items-center justify-center rounded-full bg-[#a8c7fa] text-[#001d35] border-0">
                {topTargetCode}
              </span>
            </div>
