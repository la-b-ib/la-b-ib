        ...
        <div className="font-mono pt-2">
          ...
          <div className="bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between space-y-3 relative group shadow-md">
            <div className="flex items-center justify-between">
              <div className="text-xs leading-[12px] text-[#c4c6d0] uppercase tracking-wider flex items-center space-x-1.5 font-semibold">
            ...
            <div className="text-xs text-[#8e9199] flex items-center justify-between border-t border-[#44474f]/30 pt-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-7 space-y-4 relative flex flex-col justify-start">
                ...
                <div className="flex items-center justify-between z-10 flex-wrap gap-2 border-b border-[#44474f]/30 pb-3 shrink-0">
                  ...
                  <div className="flex items-center space-x-2 text-xs font-mono text-[#a8c7fa]">
                    <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                    <span className="text-xs">GEO-LOC STREAM ACTIVE</span>
                  </div>
                </div>
                ...
                filteredLogs.map((atk) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <div
                          className="pt-2 mt-2 border-t border-[#44474f]/40 space-y-2 text-xs font-mono animate-fadeIn"
