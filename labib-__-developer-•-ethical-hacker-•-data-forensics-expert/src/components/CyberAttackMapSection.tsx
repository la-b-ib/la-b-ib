      ...
      <div className="max-w-7xl mx-auto px-0 flex flex-col gap-[15px]">
        ...
        <div className="font-mono">
          ...
          <div className="bg-[#21232b] border-0 p-3.5 sm:p-4 rounded-2xl transition-all flex flex-col justify-between space-y-3 relative group shadow-md">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-[15px] gap-x-6 lg:gap-x-8 items-start">
              {/* Interactive 3D Globe Canvas (7 Cols) */}
              <div className="lg:col-span-7 space-y-[15px] relative flex flex-col justify-start">
                {/* Threat Radar Header Container (Identical to Intel Brief Research Tab Header architecture) */}
                <div className="h-[56.9792px] bg-[#21232b] border-0 px-3.5 sm:px-4 rounded-2xl transition-all flex items-center">
                    ...
                    {CAMERA_PRESETS.map((preset) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex-1 px-2 sm:px-2.5 h-[35px] flex items-center justify-center rounded-full transition-all cursor-pointer font-bold border-0 text-center text-xs ${
                            isSelected
          ...
          <div className="lg:col-span-5 flex flex-col px-0 space-y-[15px]">
              ...
              <div className="flex flex-row items-center gap-2 w-full">
                ...
                <div className="w-[40%] min-w-0 flex items-center justify-between space-x-1 bg-[#21232b] p-1 rounded-full border-0 text-xs font-mono h-[45px] shrink-0 shadow-none">
                  ...
                  <button
                    ...
                    className={`px-2 sm:px-2.5 h-[35px] rounded-full text-xs font-bold transition-all cursor-pointer flex items-center justify-center border-0 shrink-0 ${
                      isLive
                        ? 'bg-[#ffb4ab] text-[#690005]'
                    ...
                    {[1, 2, 4].map((spd) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex-1 min-w-0 px-1 sm:px-1.5 h-[35px] rounded-full text-xs font-bold transition-all text-center cursor-pointer border-0 flex items-center justify-center ${
                            isSelected
                              ? 'bg-[#a8c7fa] text-[#001d35]'
