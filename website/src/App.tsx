...
export function App() {
  ...
  return (
    <div className="h-full sm:min-h-screen w-full bg-[#09080c] text-[#e3e2e6] flex flex-col items-center justify-start sm:justify-center font-sans antialiased sm:py-6 sm:px-4 overflow-hidden">
      ...
      <div className="w-full sm:max-w-[430px] h-full sm:h-[880px] sm:max-h-[92vh] bg-[#0f0e13] border-0 sm:border sm:border-[#49454f]/40 sm:rounded-[40px] shadow-2xl relative flex flex-col justify-start overflow-hidden sm:shadow-[0_0_50px_rgba(0,0,0,0.8)]">
        
        {/* Mobile Device Top Bar Header with Mobile Frame Toggle */}
        <div className="hidden sm:flex justify-between items-center px-4 pt-2 pb-1 bg-[#000000] sticky top-0 z-[60] border-0">
