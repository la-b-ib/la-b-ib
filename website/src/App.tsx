...
export function App() {
  ...
  return (
    <div className="h-[var(--visual-viewport-height,100dvh)] sm:min-h-[100dvh] w-full bg-[#000000] text-[#e3e2e6] flex flex-col items-center justify-start sm:justify-center font-sans antialiased sm:py-6 px-0 overflow-hidden relative" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
      ...
      <div className="w-full sm:max-w-[430px] h-[var(--visual-viewport-height,100dvh)] sm:h-[880px] sm:max-h-[92dvh] bg-[#000000] border-0 sm:border sm:border-[#49454f]/40 sm:rounded-[40px] shadow-2xl relative flex flex-col justify-start overflow-hidden sm:shadow-[0_0_50px_rgba(0,0,0,0.8)] z-10">
        ...
        <div className="hidden sm:flex justify-between items-center px-0 pt-2 pb-1 bg-[#000000] sticky top-0 z-[60] border-0 shrink-0">
        ...
        <main className={`relative z-10 flex-1 flex flex-col px-0 mt-0 min-h-0 ${terminalOpen || ctfOpen || searchOpen ? "overflow-hidden" : "overflow-y-auto"} [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden`}>
          {!isCfVerified ? (
            ...
            <>
              ...
              {/* Footer - Hidden when Terminal, CTF, Search, or Contact section is active */}
