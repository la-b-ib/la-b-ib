...
export const ArsenalSection: React.FC = () => {
  ...
  return (
    <section id="skills" className="pt-[15px] px-[15px] pb-6 border-b-0 bg-transparent relative scroll-mt-28 font-sans">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-3 flex items-center justify-between gap-2 h-[38px]">
                      <div className="flex items-center space-x-1.5 overflow-hidden text-xs leading-[12px] font-mono text-[#8e9199] bg-[#13141a] px-2.5 h-[38px] rounded-lg flex-1 min-w-0">
