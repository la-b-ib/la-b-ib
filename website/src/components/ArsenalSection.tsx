          ...
          <div className="flex items-center h-[42px] bg-[#21232b] rounded-xl px-2 max-w-2xl w-full">
            ...
            <div className="relative flex-1 flex items-center h-full">
              <input
                ...
                placeholder=""
                className="w-full h-full bg-transparent border-0 pl-1.5 pr-8 py-2 text-[13px] leading-[16px] text-white font-mono focus:outline-none placeholder-transparent"
              />
              <div className="absolute right-2 flex items-center space-x-1.5 pointer-events-none">
                {searchQuery ? (
                  <button
                    ...
                    title="Clear search"
                  >
                    <i className="ri-close-circle-line text-[13px] leading-[16px]"></i>
                  </button>
                ) : null}
