...
${formData.message}`;
 ...
 return (
    <section id="contact" className="pt-[15px] px-0 pb-[15px] border-b-0 bg-transparent relative scroll-mt-28">
 <div className="max-w-7xl mx-auto px-0">
 {/* Section Header */}
        <div className="mb-[15px]">
          <div className="flex items-center space-x-2">
            <span className="w-2 h-2 rounded-full bg-[#a8e6cf] animate-pulse"></span>
            <span className="text-[13px] leading-[16px] font-mono text-[#a8c7fa] tracking-widest uppercase font-semibold">
              Contact & Outreach
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 gap-[15px] items-start">
          ...
          <div className="bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col shadow-md space-y-2.5">
            ...
            {/* Inner Text Capsule */}
            <div className="bg-[#000000] border border-[#44474f]/30 rounded-xl p-3 text-[13px] leading-[16px] font-mono h-[85px] overflow-hidden flex items-start shrink-0">
              <p className="bg-[#000000] text-[#c4c6d0] text-[13px] leading-[16px] font-mono w-full">
                {typedNotice}
          ...
          <div className="bg-[#21232b] rounded-2xl border-0 p-[14px] shadow-md flex flex-col space-y-4 h-[525px]">
          {/* Top Bar Header */}
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-2 font-mono text-[13px] leading-[16px] flex-1 flex flex-col justify-between">
            ...
            <button
              ...
              className={`w-full font-semibold text-[13px] leading-[16px] tracking-wider pt-[12px] pb-3 px-4 rounded-xl cursor-pointer disabled:opacity-50 transition-colors flex items-center justify-center border-0 shrink-0 ${
