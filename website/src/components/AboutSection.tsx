...
export const AboutSection: React.FC = () => {
 ...
 return (
 <section id="about" className="pt-[15px] px-[15px] pb-0 border-b-0 bg-transparent relative scroll-mt-28 font-mono text-white">
 ...
 Intel Brief
              ...
              {/* Intel Brief Visual & Intro beside image in #21232b container */}
              <div className="bg-[#21232b] border-0 rounded-[16px] p-3.5 sm:p-4 flex flex-row items-center gap-[14px] my-2 h-[128px]">
                <div className="w-[100px] h-[100px] overflow-hidden shrink-0 rounded-[6px]">
                  <img
                    src="https://cdn.jsdelivr.net/gh/la-b-ib/la-b-ib@main/website%20assets/intel/intel.JPG"
                    alt="Intel Brief"
                    className="w-[100px] h-[100px] object-cover rounded-[6px] block border-0 border-dashed"
                  />
                </div>
                <div className="flex-1 min-w-0 font-sans flex flex-col justify-between h-[100px]">
                  ...
                  <p className="text-[#c4c6d0] text-[12px] sm:text-[13px] font-mono leading-relaxed h-[40px] my-1">
                    {typedBio}
