...
export const AboutSection: React.FC = () => {
 ...
 return (
    <section id="about" className="pt-[15px] px-0 pb-0 border-b-0 bg-transparent relative scroll-mt-28 font-mono text-white">
 ...
 Intel Brief
              ...
              <div className="flex flex-row items-center gap-0 my-2 w-full">
                ...
                <div
                  className="bg-[#21232b] border-0 rounded-r-[16px] rounded-l-none p-[14px] flex-1 min-w-0 font-sans flex flex-col justify-between h-[127px]"
                  style={{ width: `calc(100% - ${imageWidth}px)` }}
                >
                  <p className="text-[16px] font-bold text-white leading-snug h-[20px] mb-0" style={{ fontSize: '16px' }}>
                    Hi, I’m Labib 👋
                  </p>
                  {/* Typed Effect text directly on background */}
                  <p className="text-[#c4c6d0] text-[13px] sm:text-[13px] font-mono leading-[16px] h-[40px] mt-0 mb-1">
                    {typedBio}
 ...
 <div className="text-[13px] leading-[16px] text-[#8e9199] uppercase truncate">Academic Standing</div>
 <div className="text-[13px] leading-[16px] font-bold text-[#a8e6cf] truncate">B.Sc. CSE (3.12 GPA)</div>
 </div>
 </div>
 ...
 <div className="min-w-0">
 <div className="text-[13px] leading-[16px] text-[#8e9199] uppercase truncate">IEEE Research</div>
 <div className="text-[13px] leading-[16px] font-bold text-[#d0bcff] truncate">Xplore Published</div>
 </div>
 </div>
 ...
 <div className="min-w-0">
 <div className="text-[13px] leading-[16px] text-[#8e9199] uppercase truncate">Secretariat Leadership</div>
 <div className="text-[13px] leading-[16px] font-bold text-[#a8c7fa] truncate">IEEE CS President</div>
 </div>
 </div>
 ...
 <div className="min-w-0">
 <div className="text-[13px] leading-[16px] text-[#8e9199] uppercase truncate">Global Honor</div>
 <div className="text-[13px] leading-[16px] font-bold text-[#ffb4ab] truncate">Duke of Edinburgh Gold</div>
 </div>
 </div>
 </div>
 </div>
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="text-[13px] leading-[16px] text-[#a8c7fa] hover:text-white no-underline transition-colors shrink-0 font-mono"
 ...
 <i className="ri-trophy-line"></i>
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-sans font-medium">US Scale</span>
 </div>
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">/ 4.00</span>
 </div>
 </div>
 ...
 <i className="ri-java-line"></i>
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-sans font-medium">CORE</span>
 </div>
              <div className="h-[38px] bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-1.5 text-[13px] text-[#c4c6d0] font-mono leading-[16px] truncate flex items-center">
 Java, Python, C++
 </div>
 </div>
 ...
 <i className="ri-git-repository-private-line"></i>
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-sans font-medium">SEC</span>
 </div>
              <div className="h-[38px] bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-1.5 text-[13px] text-[#c4c6d0] font-mono leading-[16px] truncate flex items-center">
 Wireshark, eBPF
 </div>
 ...
 <i className="ri-pass-expired-line"></i>
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-sans font-medium">SYS</span>
 </div>
              <div className="h-[38px] bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-1.5 text-[13px] text-[#c4c6d0] font-mono leading-[16px] truncate flex items-center">
                mTLS, Redis L2
 </div>
 ...
 <i className="ri-team-line"></i>
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-sans font-medium">AFFIL</span>
 </div>
 <div 
                className="min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-2 text-[13px] text-[#c4c6d0] font-mono leading-[16px] whitespace-normal break-words flex items-center"
 ...
 <div className="col-span-2 min-h-[105px] h-auto bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between gap-2.5">
 <div className="h-[30px] flex items-center justify-between shrink-0">
 <div className="flex items-center gap-2 text-[13px] leading-[16px] font-bold text-[#c2e7ff]">
 <div
 ...
 <i className="ri-book-open-line"></i>
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-sans font-medium">PUBS</span>
 </div>
              <div className="min-h-[38px] h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl px-3 py-2 text-[13px] text-[#c4c6d0] font-mono leading-[16px] space-y-1">
 ...
 <div className="flex items-center gap-2.5 text-[13px] leading-[16px] font-bold text-[#c2e7ff] min-w-0 flex-1">
 <div
 ...
 <span className="text-[13px] text-[#a8c7fa] font-mono font-medium tracking-wider leading-[16px] mt-0.5">
 ...
 {isExpanded && (
 <div className="h-auto bg-[#13141a] border border-[#44474f]/30 rounded-xl p-3.5 text-[13px] leading-[16px] text-[#c4c6d0] font-mono space-y-2.5 animate-fadeIn">
 ...
 <div className="text-[13px] leading-[16px] text-[#a8e6cf] font-semibold mt-0.5">
 ...
 <span className="truncate text-[13px] text-[#a8c7fa] font-mono font-medium tracking-wider leading-[16px] mt-0.5">
 {portal.status}
 </span>
 </div>
 </div>
