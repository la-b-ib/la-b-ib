...
export const SearchSection: React.FC<SearchSectionProps> = ({
 ...
 return (
 <section className="w-full flex-1 flex flex-col bg-transparent min-h-full border-t-0 text-white font-mono animate-fadeIn pb-[calc(94px+env(safe-area-inset-bottom,0px))]">
 {/* Header Bar with Search Bar, Filter Buttons (desktop), Matches Count & Close Button */}
 <div className="bg-[#1a1b21] px-4 py-3 border-b border-[#44474f]/30 flex flex-wrap items-center justify-between gap-3 select-none">
 ...
 className={`search-result-item shrink-0 px-3 py-1.5 rounded-full border text-[13px] leading-[16px] font-mono font-medium transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
 ...
 <span className="text-[13px] leading-[16px] uppercase">{cat.label}</span>
 </button>
 ))}
 </div>
 ...
 <div
 className="px-3 py-1.5 text-[13px] leading-[16px] font-mono font-semibold rounded-full border border-[#44474f]/50 bg-[#21232b] text-[#c4c6d0] flex items-center justify-center gap-1.5 h-8"
 title="Matching search items found"
 >
 <i className="ri-radar-line text-[#8e9199] text-[13px] leading-[16px]"></i>
