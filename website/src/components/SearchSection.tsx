...
export const SearchSection: React.FC<SearchSectionProps> = ({
 ...
 <div
 className="px-3 py-1.5 text-[11px] font-mono font-semibold rounded-full border border-[#44474f]/50 bg-[#21232b] text-[#c4c6d0] flex items-center justify-center gap-1.5 h-8"
 title="Matching search items found"
 >
 <i className="ri-radar-line text-[#8e9199] text-xs"></i>
