...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <div ref={navRef} className="w-full h-[55px] flex items-center relative">
      <div className="max-w-7xl mx-auto px-[15px] flex items-center justify-between gap-4 w-full">
      ...
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 w-full bg-[#000000] backdrop-blur-2xl border-b-0 px-[15px] pt-[15px] pb-[15px] text-xs max-h-[85dvh] overflow-y-auto shadow-2xl rounded-b-3xl mt-0 z-50">
