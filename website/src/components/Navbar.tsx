...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navLinks = [
    ...
    { label: 'CREDENTIALS', icon: 'ri-certificate-2-line', num: '06', href: '#certificates' },
    { label: 'DISPATCH', icon: 'ri-article-line', num: '07', href: '#dispatch' },
    ...
    <div ref={navRef} className="w-full h-[55px] flex items-center relative">
        ...
        {!hideMenu && (
          <div className="flex items-center space-x-2 shrink-0 ml-auto">
            ...
            <button
              ...
              className={`w-[32px] h-[32px] rounded-[18px] transition-all flex items-center justify-center cursor-pointer active:scale-95 border-0 relative ${
                shareCopied
                  ? 'bg-[#a8e6cf] text-[#00391c] shadow-md'
                  : 'bg-[#21232b] hover:bg-[#2c2f3a] text-[#e3e2e6] hover:text-[#a8c7fa]'
              }`}
              title={shareCopied ? "Link Copied!" : "Airdrop / Share Portfolio"}
              aria-label="Airdrop or Share Portfolio"
            >
              <i className={shareCopied ? 'ri-checkbox-circle-line text-lg font-bold' : 'ri-broadcast-line text-lg font-bold'}></i>
              {shareCopied && (
            ...
            <button
              ...
              className={`w-[32px] h-[32px] rounded-[18px] transition-all flex items-center justify-center cursor-pointer active:scale-95 border-0 ${
                mobileMenuOpen
      ...
      {!hideMenu && mobileMenuOpen && (
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 mb-[15px] px-[8px]" style={{ paddingLeft: "8px", paddingRight: "8px" }}>
            {navLinks.map((link) => {
              const sectionId = link.href.replace('#', '');
              const isActive = activeSection === sectionId;
          ...
          <div className="pt-0 border-0 flex items-center justify-between gap-2 px-[8px]" style={{ paddingLeft: "8px", paddingRight: "8px" }}>
            {/* CTF Button */}
            <button
              onClick={() => {
                setMobileMenuOpen(false);
