...
export const Navbar: React.FC<NavbarProps> = ({
 ...
 <i className={mobileMenuOpen ? 'ri-close-circle-line text-lg font-bold' : 'ri-list-indefinite text-lg font-bold'}></i>
      ...
      {mobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 w-full bg-[#000000] backdrop-blur-2xl border-b-0 px-[15px] pt-[15px] pb-[15px] text-xs max-h-[85vh] overflow-y-auto shadow-2xl rounded-b-3xl mt-0 animate-fadeIn z-50">
