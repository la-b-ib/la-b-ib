...
===================================================================`,
 ...
 return (
 <section className="w-full h-full flex flex-col min-h-0 bg-[#09090d] text-white font-mono animate-fadeIn transition-all ">
 <div className="w-full h-full flex flex-col min-h-0 bg-[#09090d]">
        {/* Terminal Header Bar */}
        <div className="px-0 pt-0 pb-0 shrink-0 bg-[#09090d]">
          <div className="bg-[#21232b] h-[45px] px-[15px] rounded-none border-0 flex items-center gap-2 select-none">
            {/* Terminal Icon & Label */}
        ...
        <div
          className="flex-1 min-h-0 bg-[#09090d] px-[15px] pt-[15px] pb-0 font-mono text-[12px] leading-[14px] overflow-y-auto overscroll-contain space-y-2 [scrollbar-width:thin] [scrollbar-color:#44474f_#09090d] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-[#09090d] [&::-webkit-scrollbar-thumb]:bg-[#44474f] [&::-webkit-scrollbar-thumb]:rounded-full select-text touch-pan-y"
        >
 {history.map((item) => {
