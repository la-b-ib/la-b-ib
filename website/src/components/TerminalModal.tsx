...
===================================================================`,
 ...
 <div className="w-full h-full flex flex-col min-h-0 bg-[#000000]">
            ...
            >
              ...
              <div className="relative flex-1 min-w-0 flex items-center h-full">
                <input
                  ...
                  className="w-full bg-transparent border-none text-white font-mono text-[13px] leading-[16px] focus:outline-none placeholder:text-[#8e9199] placeholder:text-[13px] placeholder:leading-[16px] h-full z-10"
                />
        ...
        <div
          ...
          className="flex-1 min-h-0 bg-[#000000] px-[15px] pt-[15px] pb-0 font-mono text-[13px] leading-[16px] overflow-y-auto space-y-2 [scrollbar-width:thin] [scrollbar-color:#44474f_#000000] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-[#000000] [&::-webkit-scrollbar-thumb]:bg-[#44474f] [&::-webkit-scrollbar-thumb]:rounded-full select-text"
        >
 {history.map((item) => {
          ...
          return (
            <div key={item.id} className={`break-words ${textColorClass} grid grid-cols-[max-content_max-content_auto_1fr] gap-x-2 gap-y-0.5 items-baseline w-full`}>
              {elements.map((el, elIdx) => {
                  ...
                  if (!restAfterTag.includes(':')) {
                    ...
                    return (
                      <div key={elIdx} className="col-span-full flex items-center gap-2 font-bold pt-2 pb-0.5">
                        <span className={`text-[13px] leading-[16px] px-1.5 py-0.5 rounded border font-mono ${headerTagColor} shrink-0 select-none`}>
                          {rawTag}
                        </span>
                  ...
                  return (
                    <React.Fragment key={elIdx}>
                      <div className="flex items-center py-0.5">
                        <span className={`text-[13px] leading-[16px] px-1.5 py-0.2 rounded border font-mono font-bold ${tagBadgeColor} shrink-0 select-none`}>
                          {rawTag}
                        </span>
                      </div>
                      <div className="py-0.5 text-[13px] leading-[16px] text-[#a8c7fa] font-mono select-text whitespace-nowrap">
                        {keyPart}
                      </div>
                      <div className="py-0.5 text-[13px] leading-[16px] text-[#8e9199] font-bold select-none text-center">
                        :
                      </div>
                      <div className="py-0.5 text-[13px] leading-[16px] text-white font-medium break-words min-w-0">
                        {valPart}
                      </div>
                    </React.Fragment>
                  );
                ...
                return (
                  <div key={elIdx} className="col-span-full whitespace-pre-wrap py-0.5 text-[#c4c6d0] text-[13px] leading-[16px]">
                    {line}
                  </div>
                );
              })}
