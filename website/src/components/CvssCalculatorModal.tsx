...
export const CvssCalculatorModal: React.FC<CvssCalculatorModalProps> = ({ isOpen, onClose }) => {
 ...
 <div className="bg-[#1a1b21] rounded-2xl border border-[#44474f] w-full max-w-3xl max-h-[calc(100dvh-60px)] overflow-y-auto p-6 space-y-6 shadow-2xl relative my-auto text-white font-mono text-[13px] leading-[16px]">
 ...
 <p className="text-[13px] leading-[16px] text-[#8e9199]">FIRST Standard Vulnerability Scoring Metric System</p>
 </div>
 </div>
 ...
 <label className="text-[13px] leading-[16px] text-[#8e9199] font-bold uppercase tracking-wider">LOAD FAMOUS CVE METRICS PRESET</label>
 <div className="flex flex-wrap gap-2">
 {Object.entries(PRESET_VULNS).map(([key, val]) => (
 <button
 key={key}
 onClick={() => handleLoadPreset(key)}
 className="px-3 py-1.5 rounded-xl bg-[#13141a] hover:bg-[#21232b] border border-[#44474f]/60 text-[#c4c6d0] hover:text-white transition-all cursor-pointer text-[13px] leading-[16px] flex items-center space-x-1.5"
 >
 ...
 <div className="text-[13px] leading-[16px] text-[#8e9199] uppercase font-bold">CALCULATED BASE SCORE</div>
 <div className="flex items-center justify-center space-x-3">
 <span className="text-4xl font-bold text-white">{score.toFixed(1)}</span>
 <span className={`px-3 py-1 rounded-full border text-[13px] leading-[16px] font-bold ${color}`}>
 {severity}
 </span>
 </div>
 </div>
 ...
 <div className="text-[13px] leading-[16px] text-[#8e9199] uppercase font-bold">CVSS VECTOR STRING</div>
 <div className="bg-[#1a1b21] px-3 py-1.5 rounded-xl border border-[#44474f] text-[13px] leading-[16px] text-[#a8e6cf] font-mono break-all">
 {vectorString}
 </div>
 <button
 onClick={handleCopyVector}
 className="px-3 py-1 bg-[#004a77] hover:bg-[#00639b] text-[#c2e7ff] rounded-lg text-[13px] leading-[16px] font-bold border border-[#a8c7fa]/30 transition-all cursor-pointer inline-flex items-center space-x-1"
 >
 ...
 <div className="text-[#a8c7fa] font-bold text-[13px] leading-[16px]">ATTACK VECTOR (AV)</div>
 ...
 className={`p-1.5 rounded-lg border text-[13px] font-bold cursor-pointer transition-all ${
 ...
 <div className="p-3.5 bg-[#13141a] rounded-xl border border-[#44474f]/40 space-y-2">
 <div className="text-[#a8c7fa] font-bold text-[13px] leading-[16px]">ATTACK COMPLEXITY (AC)</div>
 <div className="grid grid-cols-2 gap-1.5">
 {[
 { k: 'L', label: 'Low (L)' },
 { k: 'H', label: 'High (H)' },
 ...
 <div className="p-3.5 bg-[#13141a] rounded-xl border border-[#44474f]/40 space-y-2">
 <div className="text-[#a8c7fa] font-bold text-[13px] leading-[16px]">PRIVILEGES REQUIRED (PR)</div>
 ...
 {/* User Interaction (UI) */}
 <div className="p-3.5 bg-[#13141a] rounded-xl border border-[#44474f]/40 space-y-2">
 <div className="text-[#a8c7fa] font-bold text-[13px] leading-[16px]">USER INTERACTION (UI)</div>
 <div className="grid grid-cols-2 gap-1.5">
 {[
 { k: 'N', label: 'None (N)' },
 ...
 {/* Scope (S) */}
 <div className="p-3.5 bg-[#13141a] rounded-xl border border-[#44474f]/40 space-y-2">
 <div className="text-[#a8c7fa] font-bold text-[13px] leading-[16px]">SCOPE (S)</div>
 <div className="grid grid-cols-2 gap-1.5">
 {[
 ...
 <div className="p-3.5 bg-[#13141a] rounded-xl border border-[#44474f]/40 space-y-2">
 <div className="text-[#a8c7fa] font-bold text-[13px] leading-[16px]">CONFIDENTIALITY IMPACT (C)</div>
 <div className="grid grid-cols-3 gap-1.5">
 {[
 { k: 'N', label: 'None' },
 { k: 'L', label: 'Low' },
 ...
 className="m3-btn-primary cursor-pointer text-[13px] leading-[16px] font-bold px-6"
 >
