        ...
        <defs>
          ...
          >
            ...
            <g transform="translate(122, 110)">
              <circle cx="5" cy="15" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.4" />
              <circle cx="16" cy="12" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.4" />
              <path
            ...
            <g transform="translate(42, 92)">
              ...
              <path d="M7 3.5v3.5l2.5 1.5" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
            </g>
            ...
            <g transform="translate(0, 0)">
              ...
              <circle cx="160" cy="0" r="1.5" fill="currentColor" />
              <circle cx="0" cy="160" r="1.5" fill="currentColor" />
              <circle cx="160" cy="160" r="1.5" fill="currentColor" />
              <path d="M0 0l3 3M160 0l-3 3M0 160l3-3M160 160l-3-3" stroke="currentColor" strokeWidth="1.2" />
            </g>
          </pattern>
        </defs>
