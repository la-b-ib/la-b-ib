    ...
    switch (activeTab) {
      ...
      case 'extension':
        return {
          ...
          colorClass: 'text-[#ffd8e4]',
          activeButtonBg: 'bg-[#ffd8e4] text-[#630030]',
          activeIconColor: 'text-[#630030]',
        };
      default:
        return {
        ...
        <div className="flex items-center gap-1 bg-[#21232b] p-1 rounded-full border-0 h-[45px] max-w-2xl w-full">
          {filterTabs.map((tab) => {
            ...
            if (tab.id === 'offsec_dfir') {
              ...
              activeColorClass = 'bg-[#ffd8e4] text-[#630030] font-semibold';
              iconActiveClass = 'text-[#630030]';
            }
          ...
          <div className="flex items-center gap-2">
            <span style={{ fontSize: "12px", lineHeight: "12px" }}>
              ...
              <strong className={currentTabMeta.colorClass}>
                {filteredCasefiles.length === 0 ? 0 : (currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredCasefiles.length)}
              </strong>{' '}
              OF <strong className="text-white">{filteredCasefiles.length}</strong>{' '}
