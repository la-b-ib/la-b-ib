  ...
  return (
    <section id="projects" className="pt-0 px-2 pb-0 border-b-0 bg-transparent relative scroll-mt-28 font-mono" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "0px", paddingBottom: "0px" }}>
      <div className="max-w-7xl mx-auto px-0 flex flex-col gap-[15px]">
        ...
        <div className="space-y-4">
          <div>
            <div className="flex items-center space-x-2 text-[13px] leading-[16px] font-mono text-[#a8c7fa] uppercase tracking-widest">
              ...
              <span className="text-[12px]" style={{ fontSize: "12px" }}>ENGINE ARCHIVES // OPEN-SOURCE & SYSTEMS</span>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 font-mono">
            ...
            <div className="h-[95px] bg-[#21232b] border-0 p-2 rounded-2xl transition-all flex flex-col justify-between" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px", height: "95px" }}>
              <div className="h-[30px] flex items-center justify-between">
                <div className="flex items-center gap-2 text-[16px] font-bold text-[#a8c7fa]">
                  ...
                  <span style={{ lineHeight: "16px" }}>ENGINES</span>
                </div>
              </div>
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl p-2 flex items-center gap-1.5" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
                <span className="text-2xl font-bold text-[#a8c7fa] font-mono tracking-tight" style={{ fontSize: "24px" }}>
                  {CASEFILES_DATA.length}
                </span>
                <span className="text-[12px] leading-[12px] text-[#8e9199] font-mono" style={{ fontSize: "12px", lineHeight: "12px" }}>ARCHIVES</span>
              </div>
            </div>
            ...
            <div className="h-[95px] bg-[#21232b] border-0 p-2 rounded-2xl transition-all flex flex-col justify-between" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px", height: "95px" }}>
              <div className="h-[30px] flex items-center justify-between">
                <div className="flex items-center gap-2 text-[16px] font-bold text-[#ffb4ab]">
                  ...
                  <span style={{ lineHeight: "16px" }}>OFFSEC & DFIR</span>
                </div>
              </div>
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl p-2 flex items-center gap-1.5" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
                <span className="text-2xl font-bold text-[#ffb4ab] font-mono tracking-tight leading-[24px]" style={{ fontSize: "24px", lineHeight: "24px" }}>
                  {categoryCounts.offsecDfir}
                </span>
                <span className="text-[12px] leading-[12px] text-[#8e9199] font-mono" style={{ fontSize: "12px", lineHeight: "12px" }}>SCANNERS & FORENSICS</span>
              </div>
            </div>
            ...
            <div className="h-[95px] bg-[#21232b] border-0 p-2 rounded-2xl transition-all flex flex-col justify-between" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px", height: "95px" }}>
              <div className="h-[30px] flex items-center justify-between">
                <div className="flex items-center gap-2 text-[16px] font-bold text-[#a8e6cf]">
                  ...
                  <span style={{ lineHeight: "16px" }}>SYSTEMS</span>
                </div>
              </div>
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl p-2 flex items-center gap-1.5" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
                <span className="text-2xl font-bold text-[#a8e6cf] font-mono tracking-tight leading-[24px]" style={{ fontSize: "24px", lineHeight: "24px" }}>
                  {categoryCounts.fullstack}
                </span>
                <span className="text-[12px] leading-[12px] text-[#8e9199] font-mono" style={{ fontSize: "12px", lineHeight: "12px" }}>AI & WEB</span>
              </div>
            </div>
            ...
            <div className="h-[95px] bg-[#21232b] border-0 p-2 rounded-2xl transition-all flex flex-col justify-between" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px", height: "95px" }}>
              ...
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl p-2 flex items-center gap-1.5" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
                <span className="text-2xl font-bold text-[#ffd8e4] font-mono tracking-tight leading-[24px]" style={{ fontSize: "24px", lineHeight: "24px" }}>
                  {categoryCounts.extension}
                </span>
                <span className="text-[12px] leading-[12px] text-[#8e9199] font-mono" style={{ fontSize: "12px", lineHeight: "12px" }}>ADD-ONS</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between text-[13px] leading-[16px] text-[#8e9199] font-mono px-1">
          <span className="flex items-center gap-1.5">
            <i className="ri-archive-stack-line text-[#a8c7fa]"></i>
            <span style={{ fontSize: "12px", lineHeight: "12px" }}>SHOWING {filteredCasefiles.length === 0 ? 0 : (currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredCasefiles.length)} OF {filteredCasefiles.length} REPOSITORIES</span>
          </span>
          {activeTab !== 'all' && (
