...
export const CasefilesSection: React.FC<CasefilesSectionProps> = () => {
 ...
 <span className="text-[10px] text-[#8e9199] font-sans font-medium">REPOS</span>
 </div>
 <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
 <span className="text-xl font-bold text-[#a8c7fa] font-mono tracking-tight">{CASEFILES_DATA.length}</span>
 ...
 <span className="text-[10px] text-[#8e9199] font-sans font-medium">SCANNERS</span>
 </div>
 <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
 <span className="text-xl font-bold text-[#ffb4ab] font-mono tracking-tight">{categoryCounts.offsec}</span>
 <span className="text-xs text-[#8e9199] font-mono">ENGINES</span>
 </div>
 </div>
 ...
 <span className="text-[10px] text-[#8e9199] font-sans font-medium">DFIR</span>
 </div>
 <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
 <span className="text-xl font-bold text-[#d0bcff] font-mono tracking-tight">{categoryCounts.dfir}</span>
 <span className="text-xs text-[#8e9199] font-mono">ACTIVE</span>
 </div>
 </div>
 ...
 <span className="text-[10px] text-[#8e9199] font-sans font-medium">AI & WEB</span>
 </div>
 <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
 <span className="text-xl font-bold text-[#a8e6cf] font-mono tracking-tight">{categoryCounts.fullstack}</span>
 <span className="text-xs text-[#8e9199] font-mono">PLATFORMS</span>
 </div>
 </div>
 </div>
 </div>
 ...
 className={`px-3 py-1.5 rounded-full text-xs font-mono transition-all flex items-center space-x-2 shrink-0 cursor-pointer ${
 isActive
 ...
 <div
 key={file.id}
 className="bg-[#21232b] rounded-2xl border-0 p-5 space-y-4 transition-all flex flex-col justify-between group relative"
 >
 <div className="space-y-3">
 {/* Title & GitHub Repo Handle */}
 <div>
 <h3 className="text-lg font-bold text-white group-hover:text-[#a8c7fa] transition-colors leading-snug">
 {file.title}
 </h3>
 {file.repoName && (
 <a
 ...
 {/* Summary */}
 <p className="text-xs text-[#c4c6d0] leading-relaxed font-sans font-normal">
 {file.summary}
 </p>
 </div>
