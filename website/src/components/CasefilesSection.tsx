...
export const CasefilesSection: React.FC<CasefilesSectionProps> = () => {
  ...
  return (
    <section id="projects" className="pt-[15px] px-0 pb-12 border-b-0 bg-transparent relative scroll-mt-28 font-mono">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 font-mono">
            ...
            <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
              ...
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">ARCHIVES</span>
              </div>
            </div>
            ...
            <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
              ...
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">SCANNERS & FORENSICS</span>
              </div>
            </div>
            ...
            <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
              ...
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">AI & WEB</span>
              </div>
            </div>
            ...
            <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
              ...
              <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
                ...
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">ADD-ONS</span>
              </div>
            </div>
          </div>
        </div>
