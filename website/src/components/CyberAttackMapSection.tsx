...
export const CyberAttackMapSection: React.FC<CyberAttackMapSectionProps> = ({
 ...
 return (
 <section id="threat-map" className="pt-[15px] px-[15px] pb-0 border-b-0 bg-transparent relative scroll-mt-28 text-white font-mono">
 ...
 <div className="bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between space-y-3 relative group shadow-md">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2 text-xs leading-[12px] text-[#c4c6d0] uppercase tracking-wider font-semibold">
 ...
 <span className="text-xs leading-[12px]">Threat MATRIX</span>
 </div>
 ...
 className={`px-2 h-[25px] flex items-center justify-center rounded-full text-xs font-bold transition-all cursor-pointer border-0 ${
 rateMode === m
 ...
 <span className="px-2 h-[25px] flex items-center justify-center rounded-full text-xs font-bold bg-[#fdd663] text-[#422c00] border-0">
 +{lastDelta}
 </span>
 </div>
 </div>
 ...
 <span className="text-2xl font-bold text-[#fdd663] tracking-tight">
 {rateMode === 'TOTAL'
 ...
 <div className="text-xs text-[#8e9199] flex items-center justify-between pt-2">
 <span className="text-xs">Avg +1,850/min global rate</span>
 <span className="text-[#fdd663] font-bold text-xs flex items-center space-x-1">
 ...
 <div className={`relative w-full aspect-square bg-transparent rounded-none border-0 overflow-hidden group shadow-inner ${crtActive ? 'animate-crt-flicker' : ''}`}>
 <GlobeGLComponent
 cities={CITIES}
 attacks={attacks}
 ...
 <div className="absolute bottom-0 left-0 right-0 z-20 flex items-center space-x-1 bg-[#1a1b21]/95 backdrop-blur-md px-0 py-1 border-t border-[#44474f]/50 text-xs font-mono justify-between h-[45px] shadow-lg">
 ...
 className={`flex-1 px-2 h-[35px] flex items-center justify-center rounded-full transition-all cursor-pointer font-bold border-0 text-center text-xs ${
 isSelected
 ...
 className={`px-2.5 h-[35px] rounded-full transition-all cursor-pointer font-bold border-0 flex items-center justify-center space-x-1 text-center shrink-0 text-xs ${
 autoRotate
 ? 'bg-[#a8c7fa] text-[#001d35]'
 : 'text-[#c4c6d0] hover:text-white hover:bg-[#21232b]'
 }`}
 ...
 <div className="bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between space-y-3 relative font-mono shadow-md">
 <div className="flex items-center justify-between">
 <div className="text-xs text-[#c4c6d0] uppercase tracking-wider flex items-center space-x-1.5 font-semibold">
 <i className="ri-route-line text-[#a8c7fa] text-xs"></i>
 <span className="text-xs">ATTACK FLOW</span>
 </div>
 <div className="flex items-center space-x-1.5 text-xs text-[#8e9199]">
 <span className="w-1.5 h-1.5 rounded-full bg-[#a8c7fa] animate-ping"></span>
 <span className="text-[#a8c7fa] font-bold text-xs">VECTOR CORRIDOR</span>
 </div>
 </div>
 ...
 <div className="w-7 h-7 rounded-full bg-[#13141a] flex items-center justify-center shrink-0 border border-[#44474f]/30">
 <i className="ri-global-line text-[#a8c7fa] text-xs"></i>
 </div>
 <div className="min-w-0 flex-1 overflow-hidden">
 <div className="text-xs font-bold text-white truncate leading-tight block"title={topSourceName.toUpperCase()}>
 {topSourceName.toUpperCase()}
 </div>
 <div className="text-xs leading-[12px] font-bold text-[#8e9199] tracking-wider uppercase block">
 ORIGIN
 </div>
 </div>
 </div>
 ...
 <div className="flex justify-between text-xs text-[#8e9199] font-medium">
 <span className="truncate text-xs">Botnet Share</span>
 <span className="text-[#a8c7fa] shrink-0 font-mono font-bold ml-1 text-xs">{topSourceShare}%</span>
 </div>
 <div className="w-full bg-transparent rounded-full h-1.5 border border-[#44474f]/30 overflow-hidden">
 <div
 ...
 <div className="flex items-center space-x-2 min-w-0 flex-1 overflow-hidden">
 <div className="w-7 h-7 rounded-full bg-[#13141a] flex items-center justify-center shrink-0 border border-[#44474f]/30">
 <i className="ri-database-line text-[#a8c7fa] text-xs"></i>
 </div>
 <div className="min-w-0 flex-1 overflow-hidden">
 <div className="text-xs font-bold text-white truncate leading-tight block"title={topTargetName.toUpperCase()}>
 ...
 <div className="space-y-1 pt-1">
 <div className="flex justify-between text-xs text-[#8e9199] font-medium">
 <span className="truncate text-xs">Target Share</span>
 <span className="text-[#a8c7fa] shrink-0 font-mono font-bold ml-1 text-xs">{topTargetShare}%</span>
 </div>
 <div className="w-full bg-transparent rounded-full h-1.5 border border-[#44474f]/30 overflow-hidden">
 <div
 className="bg-[#a8c7fa] h-full rounded-full transition-all duration-500"
 ...
 <div className="flex flex-col px-0 space-y-[15px]">
 {/* Live Incident Header Container (Identical to Threat Radar Header architecture) */}
 <div className="h-[56.9792px] bg-[#21232b] border-0 px-3.5 rounded-2xl transition-all flex items-center">
 <div className="flex items-center gap-3 min-w-0">
 <div className="w-[32px] h-[32px] rounded-[8px] bg-[#a8c7fa] text-[#001d35] border-0 shadow-md flex items-center justify-center text-base font-bold shrink-0">
 ...
 <div className="w-[40%] min-w-0 flex items-center justify-between space-x-1 bg-[#21232b] p-1 rounded-full border-0 text-xs font-mono h-[45px] shrink-0 shadow-none">
 ...
 className={`px-2 h-[35px] rounded-full text-xs font-bold transition-all cursor-pointer flex items-center justify-center border-0 shrink-0 ${
 isLive
 ? 'bg-[#ffb4ab] text-[#690005]'
 ...
 className={`flex-1 min-w-0 px-1 h-[35px] rounded-full text-xs font-bold transition-all text-center cursor-pointer border-0 flex items-center justify-center ${
 isSelected
 ? 'bg-[#a8c7fa] text-[#001d35]'
 ...
 placeholder=""
 className="w-full h-[45px] bg-[#21232b] border-0 text-white pl-3.5 pr-8 rounded-full text-xs font-mono focus:outline-none focus:ring-0"
 />
 {searchQuery ? (
 <button
 ...
 className={`flex-1 min-w-[50px] h-[35px] flex items-center justify-center text-xs font-mono font-bold rounded-full transition-colors cursor-pointer text-center ${
 filterSeverity === sev
 ...
 >
 <div className="flex items-center justify-between">
 <span className="text-xs text-[#8e9199]">[{atk.id}] {atk.timestamp}</span>
 <div className="flex items-center space-x-1.5">
 <span
 className={`inline-block w-[64px] h-[18.4375px] leading-[18px] flex items-center justify-center text-center text-xs font-bold rounded-full border-0 ${
 ...
 return (
 <span
 className="w-[76px] h-[18.4375px] inline-flex items-center justify-center text-center text-xs font-bold font-mono rounded-full border-0 shadow-none shrink-0"
 style={{
 ...
 <span className="text-xs font-mono text-[#c4c6d0] font-normal">
 <code style={{ color: atkColor }} className="font-bold text-xs">{atk.port}</code> ({atk.protocol})
 </span>
 </div>

 <div className="text-xs text-[#c4c6d0] truncate flex items-center space-x-1">
 <span className="text-[#a8c7fa] font-semibold text-xs">{atk.sourceCity} [{atk.sourceCode}]</span>
 <i className="ri-arrow-right-line text-xs text-[#8e9199]"></i>
 <span className="text-[#a8e6cf] font-semibold text-xs">{atk.targetCity} [{atk.targetCode}]</span>
 </div>

 {/* Inline Dropdown Details */}
 {isSelected && (
 <div
 className="mt-2 space-y-2 text-xs font-mono animate-fadeIn"
 onClick={(e) => e.stopPropagation()}
 >
 <div className="grid grid-cols-1 gap-1 text-[#c4c6d0] text-xs">
 <div className="text-xs">
 <span className="text-[#8e9199] text-xs">SOURCE IP:</span>{' '}
 <span className="text-[#ffb4ab] font-bold text-xs">{atk.sourceIP}</span>
 </div>
 <div className="text-xs">
 <span className="text-[#8e9199] text-xs">PORT:</span>{' '}
 <span className="text-white font-semibold text-xs">{atk.port} ({atk.protocol})</span>
 </div>
 <div className="text-xs">
 <span className="text-[#8e9199] text-xs">CVE:</span>{' '}
 <span className="text-[#fdd663] font-bold text-xs">{atk.cveId}</span>
 </div>
 <div className="truncate flex items-center justify-between text-xs">
 <span className="text-xs">
 <span className="text-[#8e9199] text-xs">STATUS:</span>{' '}
 <span className={isMitigated || isBlocked ? 'text-[#a8e6cf] font-bold text-xs' : 'text-[#a8c7fa] font-semibold text-xs'}>
 ...
 <div className="pt-1 flex items-center gap-1.5 min-w-0 overflow-hidden text-xs">
 <span className="text-[#8e9199] font-mono shrink-0 text-xs">PAYLOAD:</span>
 <span className="text-[#ffb4ab] font-mono truncate select-all text-xs">{atk.payloadSnippet}</span>
 </div>
 </div>

 {/* 5-Button Slider Capsule (bg pure dark #0f0e13, no border, button selection color #a8c7fa) */}
 <div className="mt-2 flex items-center space-x-1 bg-transparent px-2 py-1 rounded-full border-0 text-[10px] font-mono h-[45px] w-full justify-between shadow-none">
 ...
 {toastMessage && (
 <div className="sticky bottom-4 right-4 ml-auto w-fit z-50 bg-[#1a1b21] text-white border border-[#a8c7fa]/50 font-mono text-xs font-semibold px-4 py-3 rounded-2xl shadow-2xl flex items-center space-x-2.5 animate-bounce">
