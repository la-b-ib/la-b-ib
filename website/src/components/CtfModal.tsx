...
export const CtfModal: React.FC<CtfModalProps> = ({ isOpen, onClose }) => {
 ...
 <span className="text-[13px] leading-[16px] font-mono font-semibold text-white flex items-center space-x-2">
 ...
 {/* Main CTF Body */}
    <div className="flex-1 w-full max-w-4xl mx-auto px-0 pt-[15px] pb-8 flex flex-col justify-start">
 <div className="flex flex-col items-start justify-between mb-[15px] shrink-0">
 <div>
 <div className="flex items-center gap-2 text-[13px] leading-[16px] font-mono text-[#a8c7fa] tracking-wider uppercase">
 <span className="w-1.5 h-1.5 rounded-full bg-[#a8c7fa] shadow-[0_0_8px_rgba(168,199,250,0.8)] animate-pulse"></span>
 Capture The Flag
 </div>
 <h2 className="text-xl font-bold text-white mt-1 leading-[20px]">
 ...
 {/* Challenge Box */}
 <div className="bg-[#21232b] p-[15px] min-h-[170px] h-auto rounded-2xl space-y-4 font-mono text-[13px] leading-[16px] shrink-0">
 <div className="flex items-center justify-between text-[#c4c6d0] font-semibold">
 <span>CHALLENGE HINT & BASE64 CIPHER PAYLOAD:</span>
 </div>
 <div className="h-[45px] bg-[#000000] px-[15px] mb-[15px] rounded-xl border border-[#44474f]/30 text-[#fdd663] text-[13px] leading-[16px] font-mono select-all flex items-center justify-between gap-2 overflow-hidden">
 ...
 className={`w-full h-[45px] bg-[#000000] rounded-xl px-[15px] pr-12 ${errorMsg ? 'text-transparent' : 'text-white'} font-mono text-[13px] leading-[16px] focus:outline-none transition-colors`}
 />
