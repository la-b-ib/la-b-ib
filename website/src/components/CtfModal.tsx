...
export const CtfModal: React.FC<CtfModalProps> = ({ isOpen, onClose }) => {
 ...
 <div className="bg-[#21232b] px-4 h-[45px] flex items-center justify-between select-none shrink-0">
 ...
 <span className="hidden text-[10px] text-[#ffb870] bg-[#4a2800]/40 px-2.5 py-0.5 rounded-full border border-[#ffb870]/30 font-medium ml-2">
 LEVEL: 01_CRYPTO
 </span>
 </span>
 </div>
 ...
 {/* Main CTF Body */}
 <div className="flex-1 w-full max-w-4xl mx-auto px-4 pt-[15px] pb-8 flex flex-col justify-start">
 ...
 {/* Challenge Box */}
 <div className="bg-[#21232b] p-[15px] min-h-[170px] h-auto rounded-2xl space-y-4 font-mono text-xs shrink-0">
 <div className="flex items-center justify-between text-[#c4c6d0] font-semibold">
 <span>CHALLENGE HINT & BASE64 CIPHER PAYLOAD:</span>
 </div>
 <div className="h-[45px] bg-[#000000] px-[15px] mb-[15px] rounded-xl border border-[#44474f]/30 text-[#fdd663] text-xs font-mono select-all flex items-center justify-between gap-2 overflow-hidden">
