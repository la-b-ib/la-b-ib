...
export const DispatchSection: React.FC<DispatchSectionProps> = () => {
 ...
 return (
    <section id="dispatch" className="pt-[15px] px-0 pb-0 border-b-0 bg-transparent relative scroll-mt-28 font-mono">
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">PUBLISHED</span>
 </div>
 </div>
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">ZERO-DAYS</span>
 </div>
 </div>
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">REPRO</span>
 </div>
 </div>
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">ENRCH</span>
 </div>
 </div>
 </div>
 </div>
 ...
 {/* CATEGORY FILTER CAPSULE MATCHING ARSENAL DESIGN */}
      ...
      <div className="bg-[#21232b] rounded-xl px-3.5 py-2.5 flex items-center justify-between text-[13px] leading-[16px] text-[#8e9199] font-mono border-0">
        ...
        {totalPages > 1 && (
          <span className="text-[13px] leading-[16px] text-[#8e9199]">
 ...
 <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
              ...
              >
                ...
                <span className={`text-[13px] leading-[16px] font-mono ${likedIds[dispatch.id] ? 'font-bold text-[#a8c7fa]' : 'text-[#a8c7fa]'}`}>
 ...
 <p className="text-[13px] text-[#e2e2e9] leading-[16px] font-sans font-normal pl-0">
 {dispatch.summary}
 </p>
 </div>
 ...
 <p className="text-[13px] text-[#c4c6d0] leading-[16px] font-sans pl-0">
 {dispatch.plainEnglish}
 </p>
 </div>
 )}
 ...
 <ul className="space-y-1.5 text-[13px] leading-[16px] text-[#c4c6d0] font-sans pl-0">
 ...
 <ul className="space-y-2 text-[13px] leading-[16px] text-[#c4c6d0] font-sans pl-0">
 ...
 <div className="bg-[#21232b] rounded-xl p-3.5 space-y-2.5 border-0 font-mono text-[13px] leading-[16px]">
 <div className="flex items-center gap-2.5">
 <div className="w-8 h-8 shrink-0 rounded-lg bg-[#a8c7fa] text-[#00325b] flex items-center justify-center text-base font-bold shadow-sm">
 ...
 <div className="bg-[#13141a] p-2.5 rounded-lg text-[13px] leading-[16px] space-y-1.5 font-mono">
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] uppercase">SHA256:</span>
 </div>
 <button
 ...
 <div className="text-[#a8c7fa] text-[13px] leading-[16px] break-all font-mono">
 {dispatch.iocs.sha256}
 </div>
 </div>
 )}
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] uppercase">AFFECTED ARTIFACT PATHS:</span>
 </div>
 <button
 ...
 <div className="space-y-1 text-[#c4c6d0] text-[13px] leading-[16px] break-all">
 ...
 <span className="text-[13px] leading-[16px] text-[#8e9199] uppercase">REPRODUCIBILITY:</span>
 </div>
 <button
 ...
 <div className="text-[#a8c7fa] overflow-x-auto select-all text-[13px] leading-[16px] break-all">
 ...
 {/* YARA Detection Rule */}
 {dispatch.yaraRule && (
 <div className="bg-[#21232b] rounded-xl p-3.5 space-y-2 border-0 font-mono text-[13px] leading-[16px]">
 <div className="flex items-center justify-between text-[13px] leading-[16px] text-[#8e9199]">
 ...
 <pre className="text-[#a8c7fa] text-[13px] leading-[16px] whitespace-pre-wrap break-words break-all p-2.5 bg-[#13141a] rounded-lg">
