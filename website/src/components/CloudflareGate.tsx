  ...
  return (
    <div className="w-full flex-1 flex flex-col p-4 sm:p-5 font-mono select-none overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
      ...
      <div className="mb-[15px] shrink-0">
          ...
          <h2 className="text-3xl leading-[36px] font-extrabold tracking-tight text-white flex items-center gap-3">
            Security Clearance
          </h2>
        </div>
        ...
        <div className="mb-[15px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col shadow-md space-y-2.5 shrink-0">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-1.5 bg-[#000000] px-2.5 h-[18.4375px] rounded-full border border-[#44474f]/30">
        ...
        <div className="bg-[#21232b] rounded-2xl border-0 p-[14px] shadow-md flex flex-col space-y-4 shrink-0">
          ...
          <div className="bg-[#000000] rounded-xl px-3.5 py-2.5 flex flex-col space-y-2 text-white border border-[#44474f]/30 font-mono text-xs">
            <div className="flex items-center justify-between">
              <span className="text-[#8e9199] text-[12px]">RAY-ID</span>
              <span className="text-[#a8c7fa] text-[12px] font-mono">{rayId}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-[#8e9199] text-[12px]">SECURITY PROTOCOL</span>
              <span className="text-[#c4c6d0] text-[12px] font-mono">TLS 1.3 / NONCE SIGNED</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full text-center text-[12px] font-mono text-[#8e9199] hover:text-[#a8c7fa] transition-colors py-2 flex items-center justify-center gap-1.5 cursor-pointer border border-[#44474f]/30 rounded-xl bg-[#000000]"
          >
            <i className="ri-skip-forward-line text-xs text-[#a8c7fa]"></i>
            <span className="tracking-wide text-[12px]">BYPASS GATE (TESTING MODE)</span>
          </button>
        </div>
    </div>
  );
