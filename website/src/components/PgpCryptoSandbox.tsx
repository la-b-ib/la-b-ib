...
- Status : MATCH (Constant-Time String Compare: 0 ns delta)`;
 ...
 {/* Header */}
 <div>
 <div className="flex items-center space-x-2 text-[13px] leading-[16px] font-mono text-[#a8e6cf] uppercase tracking-wider">
 <i className="ri-key-line text-sm"></i>
 <span>PKI-LAB</span>
 </div>
 <h3 className="text-xl font-bold text-white mt-1">Crypto Sig Sandbox</h3>
 <p className="text-[13px] leading-[16px] text-[#c4c6d0] mt-0.5 mb-[15px]">
 Verify communications integrity using PGP public key and SHA-256 HMAC digester.
 </p>
 </div>

 {/* PGP KEY CARD - Container with bg #21232b */}
 <div className="h-[120px] bg-[#21232b] p-3.5 rounded-2xl border-0 flex flex-col justify-between font-mono text-[13px] leading-[16px]">
 ...
 <div className="text-[#fdd663] font-mono tracking-tight break-all select-all flex-1 min-w-0 text-[13px] leading-[16px]">
 {pgpFingerprint}
 </div>
 </div>
 </div>
 ...
 onChange={(e) => setInputText(e.target.value)}
            ...
            className="w-full h-[45px] leading-[16px] bg-[#13141a] border-0 rounded-xl p-3 text-white text-[13px] focus:outline-none placeholder:text-[#8e9199] resize-none font-mono"
 />
 </div>
 ...
 className={`flex-1 h-[35px] flex items-center justify-center rounded-full transition-colors cursor-pointer text-center text-[13px] leading-[16px] font-mono ${
 algo === item.id
 ...
 onChange={(e) => setSecretKey(e.target.value)}
            style={{ fontSize: '13px', lineHeight: '16px' }}
            className="w-full h-[46px] bg-[#13141a] border-0 rounded-xl px-3 py-2.5 text-white text-[13px] leading-[16px] focus:outline-none placeholder:text-[#8e9199] font-mono"
 />
 </div>
 </div>
