...
- Status : MATCH (Constant-Time String Compare: 0 ns delta)`;
 ...
 {/* Header */}
 <div>
 <div className="flex items-center space-x-2 text-[12px] leading-[16px] font-mono text-[#a8e6cf] uppercase tracking-wider" style={{ fontSize: "12px", lineHeight: "16px" }}>
          <i className="ri-key-line text-sm"></i>
          <span style={{ fontSize: "16px", fontStyle: "normal" }}>PKI-LAB</span>
        </div>
 ...
 <p className="text-[12px] leading-[16px] text-[#c4c6d0] mt-0.5 mb-[15px]" style={{ fontSize: "12px" }}>
 Verify communications integrity using PGP public key and SHA-256 HMAC digester.
 </p>
 </div>

 {/* PGP KEY CARD - Container with bg #21232b */}
 <div className="h-[100px] bg-[#21232b] p-2 rounded-2xl border-0 flex flex-col justify-between font-mono text-[13px] leading-[16px]" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px", height: "100px" }}>
 <div className="flex items-center justify-between text-[#8e9199] gap-2 pb-0">
 <div className="flex items-center gap-2.5 flex-wrap">
 <span style={{ fontSize: "12px", lineHeight: "12px" }}>GPG PUBLIC KEY ID: <strong className="text-[#a8c7fa]">{pgpKeyId}</strong></span>
 <span className="text-[#a8e6cf] font-bold" style={{ fontSize: "12px", lineHeight: "12px" }}>ALGO : RSA 4096-BIT / ECC</span>
 </div>
 <button
 type="button"
 ...
 <div className="h-[45px] bg-[#13141a] p-2 rounded-xl border-0 flex items-center" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
 <div className="text-[#fdd663] font-mono tracking-tight break-all select-all flex-1 min-w-0 text-[12px] leading-[16px]" style={{ fontSize: "12px" }}>
 {pgpFingerprint}
 </div>
 </div>
 </div>
 ...
 <div className="font-mono text-[13px] leading-[16px] mt-[15px] space-y-[15px]">
 {/* Container for Input Form Controls */}
 <div className="bg-[#21232b] p-2 rounded-2xl border-0 space-y-3 h-[223.7px]" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px", height: "223.7px" }}>
          <div className="text-[13px] leading-[16px] font-bold text-[#a8c7fa] flex items-center gap-2">
 ...
 <textarea
            ...
            style={{ fontSize: "12px", lineHeight: "16px", paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}
            className="w-full h-[45px] leading-[16px] bg-[#13141a] border-0 rounded-xl p-2 text-white text-[12px] focus:outline-none placeholder:text-[#8e9199] resize-none font-mono"
          />
 </div>
 ...
 <input
            ...
            className="w-full h-[46px] bg-[#13141a] border-0 rounded-xl p-2 text-white text-[12px] leading-[12px] focus:outline-none placeholder:text-[#8e9199] font-mono"
          />
 </div>
 </div>
 ...
 <div className="text-[13px] leading-[16px] text-[#a8e6cf] font-bold flex items-center justify-between">
 <span>SIGNATURE BLOCK</span>
 <span className="bg-[#a8e6cf] text-[#003923] px-2.5 py-0.5 rounded-full border-0 font-bold text-[13px] leading-[16px]">
 AUTHENTICATED
 </span>
 </div>
 <pre className="text-[13px] leading-[16px] text-[#c4c6d0] bg-[#13141a] p-[10px] rounded-lg border-0 whitespace-pre-wrap break-words break-all font-mono overflow-x-hidden">
 {signatureOutput}
 </pre>
 </div>
 )}
