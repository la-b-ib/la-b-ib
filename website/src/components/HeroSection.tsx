...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenTerminal, onNavigate }) => {
 ...
 return (
 <section id="hero" className="relative pt-0 pb-0 border-b-0 overflow-hidden scroll-mt-28 bg-transparent">
 ...
 className="w-full h-auto object-cover rounded-none block px-[10px]"
 />
 </div>
 ...
 <h1 className="text-3xl font-source-code-black tracking-tight text-slate-100 leading-tight">
 Labib{' '}
 <span
 onMouseEnter={() => {
 runDecipher();
 ...
 <div className="font-jetbrains text-xs text-teal-300/90 flex items-center space-x-2 bg-[#21232b] px-3 rounded-lg border-0 h-[45px] max-w-[346px] w-full min-h-0 shadow-none">
 ...
 <div className="bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all shadow-md">
 <p className="text-[#c4c6d0] text-sm leading-relaxed font-sans max-w-2xl">
 ...
 className="p-3.5 rounded-2xl transition-all duration-300 cursor-pointer relative overflow-hidden group border-0 bg-[#21232b] hover:opacity-90 shadow-md"
 >
 ...
 <div className="bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all shadow-md space-y-3">
 {/* Header */}
 ...
 className="w-full bg-transparent border-0 rounded-lg px-3 h-[45px] text-white font-mono text-xs focus:outline-none focus:ring-1 focus:ring-[#a8c7fa]"
 />
 </div>
 ...
 <div className="h-[56.9792px] bg-[#21232b] border-0 px-3.5 rounded-2xl transition-all flex items-center shadow-md">
 ...
 <div
 key={idx}
 className="h-[69.4792px] bg-[#21232b] border-0 px-3 rounded-xl transition-all shadow-sm flex items-center gap-2.5 leading-relaxed text-xs shrink-0"
 >
