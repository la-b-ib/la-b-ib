...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenTerminal, onNavigate }) => {
 ...
 <div className="space-y-[15px] h-[238.4376px] max-h-[238.4376px] overflow-y-auto font-mono text-xs px-0 custom-scrollbar" style={{ paddingLeft: "0px", paddingRight: "0px" }}>
 ...
 <div
 key={idx}
 className="h-[69.4792px] bg-[#21232b] border-0 px-2 rounded-xl transition-all shadow-sm flex items-center gap-2.5 leading-relaxed text-xs shrink-0" style={{ paddingLeft: "8px", paddingRight: "8px" }}
 >
