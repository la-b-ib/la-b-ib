...
export const Footer: React.FC<FooterProps> = ({
 ...
 return (
 <footer className={`w-full bg-transparent border-0 border-t-0 shadow-none px-[8px] ${activeSection === 'skills' ? 'pt-0' : activeSection === 'hero' || activeSection === 'experience' || activeSection === 'about' || activeSection === 'threat-map' || activeSection === 'dispatch' || activeSection === 'certificates' || activeSection === 'contact' ? 'pt-[15px]' : 'pt-6 '} pb-[calc(env(safe-area-inset-bottom,0px)+15px)] text-[13px] leading-[16px] font-mono text-[#8e9199] relative z-20`} style={{ paddingLeft: '8px', paddingRight: '8px' }}>
      <div
 ...
 <div className="bg-[#21232b] rounded-2xl border-0 shadow-none space-y-6 text-[13px] leading-[16px] font-mono h-auto p-2" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px", height: "auto" }}>
