    ...
    <div className={`mt-6 bg-transparent border-0 transition-all font-mono ${className}`}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#21232b]">
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="flex items-center gap-1 text-[13px] leading-[16px] font-sans px-1.5 py-0.5 rounded bg-[#003824] text-[#a8e6cf] border border-[#006d32]/50">
            ...
            <div className="flex items-center gap-2 mt-0.5">
              <a
                ...
                className="text-[13px] leading-[16px] text-[#a8c7fa] hover:underline flex items-center gap-1 font-sans"
              >
                @{username}
                <i className="ri-external-link-line text-[13px] leading-[16px]"></i>
              </a>
              {liveData?.lastUpdated && (
                <span className="text-[13px] leading-[16px] text-[#8e9199] font-sans">
                  • Synced
                </span>
              )}
            </div>
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          <div className="flex items-center gap-1 bg-[#13141a] border border-[#21232b] p-1 rounded-xl w-fit">
            {availableYears.map((yr) => (
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-[13px] font-semibold transition-all cursor-pointer border-0 ${
                  selectedYear === yr
          ...
          >
            <i className={`ri-refresh-line text-[13px] leading-[16px] ${isRefreshing ? 'animate-spin' : ''}`}></i>
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 my-4 font-mono">
        ...
        <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
          ...
          <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
            ...
            <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">ANNUAL</span>
          </div>
        </div>
        ...
        <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
          ...
          <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
            ...
            <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">DAYS PEAK</span>
          </div>
        </div>
        ...
        <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
          ...
          <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
            ...
            <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">DAYS CONT</span>
          </div>
        </div>
        ...
        <div className="h-[105px] bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col justify-between">
          ...
          <div className="h-[38px] bg-[#13141a] border-0 rounded-xl px-3 py-1.5 flex items-center gap-1.5">
            ...
            <span className="text-[13px] leading-[16px] text-[#8e9199] font-mono">PUBLIC PROD</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative mt-2">
        <div className="overflow-x-auto pb-2 [scrollbar-width:thin] [scrollbar-color:#44474f_transparent]">
          <div className="min-w-[775px] select-none">
            {/* Month Labels Bar */}
            <div className="flex text-[13px] leading-[16px] text-[#8e9199] mb-1.5 pl-7 relative h-5">
            ...
            <div className="flex items-start gap-1.5">
              {/* Day of Week Labels */}
              <div className="flex flex-col justify-between text-[13px] leading-[16px] text-[#8e9199] h-[98px] pr-1.5 pt-[2px]">
        ...
        <div className="mt-3 bg-[#21232b] border-0 p-3.5 rounded-2xl transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-[13px] leading-[16px]">
          <div className="text-[13px] leading-[16px] text-[#c4c6d0] min-h-[20px] flex items-center gap-1.5 flex-wrap">
            {hoveredDay ? (
              <>
                <span className="w-2.5 h-2.5 rounded-full bg-[#a8e6cf] animate-pulse"></span>
                <span className="font-bold text-white text-[13px] leading-[16px]">{hoveredDay.count} contribution{hoveredDay.count !== 1 ? 's' : ''}</span>
                <span className="text-[#8e9199] text-[13px] leading-[16px]">on</span>
                <span className="text-[#a8c7fa] text-[13px] leading-[16px] font-bold">{hoveredDay.date}</span>
              </>
            ) : (
              <span className="text-[#8e9199] text-[13px] leading-[16px]">
          ...
          {/* Legend */}
          <div className="flex items-center space-x-1.5 text-[13px] leading-[16px] text-[#8e9199] shrink-0 self-end sm:self-auto">
            <span className="text-[13px] leading-[16px]">Less</span>
            ...
            <span className="text-[13px] leading-[16px]">More</span>
          </div>
        </div>
      </div>
    </div>
