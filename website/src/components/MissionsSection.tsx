...
export const MissionsSection: React.FC = () => {
 ...
 return (
    <section id="experience" className="pt-[15px] pb-0 px-0 border-b-0 bg-transparent relative scroll-mt-28">
 ...
 <p className="text-[13px] font-medium text-[#a8c7fa] leading-[16px] mt-1">
 ...
 <p className="text-[13px] text-[#c4c6d0] leading-[16px] font-sans text-justify">
 {mission.summary}
 </p>
 </div>
 ...
 <span className="text-[13px] text-[#a8c7fa] font-mono font-medium tracking-wider leading-[16px] mt-1 break-words">
 {rec.role}
 </span>
 </div>
 </div>
 ...
 {/* Content Capsule Box */}
 {isRecExpanded && (
 <div className="min-h-[38px] h-auto bg-[#000000] border border-[#44474f]/30 rounded-xl p-3.5 text-[13px] leading-[16px] text-[#c4c6d0] font-sans flex-1">
 <p className="text-[13px] text-[#c4c6d0] font-sans leading-[16px] text-justify italic">
 {rec.quote}
 </p>
 </div>
 )}
