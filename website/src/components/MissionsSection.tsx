...
export const MissionsSection: React.FC = () => {
 ...
 return (
    <section id="experience" className="pt-0 pb-0 px-[8px] border-b-0 bg-transparent relative scroll-mt-28" style={{ paddingTop: "0px", paddingLeft: "8px", paddingRight: "8px" }}>
 ...
 <div
 key={mission.id}
 className="bg-[#21232b] border-0 p-2 rounded-2xl transition-all relative overflow-hidden group" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}
 >
 {/* Header Row */}
 <div>
 ...
 <p className="text-[12px] font-medium text-[#a8c7fa] leading-[16px] mt-1" style={{ fontSize: "12px" }}>
 ...
 <div className="bg-[#000000] border border-[#44474f]/30 rounded-xl p-2 mt-3" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
 ...
 {/* Header Container */}
 <div className="bg-[#21232b] border-0 p-2 rounded-2xl transition-all" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
 ...
 <h3 className="text-[16px] leading-[16px] font-bold text-white truncate" style={{ lineHeight: "16px" }}>
 Endorsements
 </h3>
 <div className="text-[12px] leading-[12px] text-[#a8c7fa] font-semibold mt-0.5" style={{ fontSize: "12px", lineHeight: "12px" }}>
 ...
 style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}
                  className={`bg-[#21232b] border-0 p-2 rounded-2xl transition-all flex flex-col justify-between group relative shadow-md ${
 ...
 <span className="text-[12px] text-[#a8c7fa] font-mono font-medium tracking-wider leading-[12px] mt-1 break-words" style={{ fontSize: "12px", lineHeight: "12px" }}>
 {rec.role}
 </span>
 </div>
 </div>
 ...
 {/* Content Capsule Box */}
 {isRecExpanded && (
 <div className="min-h-[38px] h-auto bg-[#000000] border border-[#44474f]/30 rounded-xl p-2 text-[12px] leading-[16px] text-[#c4c6d0] font-sans flex-1" style={{ paddingLeft: "8px", paddingRight: "8px", paddingTop: "8px", paddingBottom: "8px" }}>
